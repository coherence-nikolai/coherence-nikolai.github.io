...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function qa(e,t,n){let r=new Float32Array(Na),i=new H(0,1,0);return new vi({name:`SphericalGaussianBlur`,defines:{n:Na,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Xa(),fragmentShader:`
	...
	`}var Za=class extends At{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ni(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
}`,Dc=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new ai(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new vi({vertexShader:Tc,fragmentShader:Ec,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Pr(new si(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},Oc=class extends tt{constructor(e,t){super();let n=this,r=null,i=1,a=null,o=`local-floor`,s=1,c=null,u=null,d=null,f=null,p=null,h=null,g=typeof XRWebGLBinding<`u`,_=new Dc,v={},b=t.getContextAttributes(),x=null,S=null,C=[],D=[],ee=new ut,O=null,k=new Zi;k.viewport=new Ot;let te=new Zi;te.viewport=new Ot;let A=[k,te],j=new aa,ne=null,re=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(e){let t=C[e];return t===void 0&&(t=new un,C[e]=t),t.getTargetRaySpace()},this.getControllerGrip=function(e){let t=C[e];return t===void 0&&(t=new un,C[e]=t),t.getGripSpace()},this.getHand=function(e){let t=C[e];return t===void 0&&(t=new un,C[e]=t),t.getHandSpace()};function M(e){let t=D.indexOf(e.inputSource);if(t===-1)return;let n=C[t];n!==void 0&&(n.update(e.inputSource,e.frame,c||a),n.dispatchEvent({type:e.type,data:e.inputSource}))}function ie(){r.removeEventListener(`select`,M),r.removeEventListener(`selectstart`,M),r.removeEventListener(`selectend`,M),r.removeEventListener(`squeeze`,M),r.removeEventListener(`squeezestart`,M),r.removeEventListener(`squeezeend`,M),r.removeEventListener(`end`,ie),r.removeEventListener(`inputsourceschange`,ae);for(let e=0;e<C.length;e++){let t=D[e];t!==null&&(D[e]=null,C[e].disconnect(t))}ne=null,re=null,_.reset();for(let e in v)delete v[e];e.setRenderTarget(x),p=null,f=null,d=null,r=null,S=null,fe.stop(),n.isPresenting=!1,e.setPixelRatio(O),e.setSize(ee.width,ee.height,!1),n.dispatchEvent({type:`sessionend`})}this.setFramebufferScaleFactor=function(e){i=e,n.isPresenting===!0&&z(`WebXRManager: Cannot change framebuffer scale while presenting.`)},this.setReferenceSpaceType=function(e){o=e,n.isPresenting===!0&&z(`WebXRManager: Cannot change reference space type while presenting.`)},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(e){c=e},this.getBaseLayer=function(){return f===null?p:f},this.getBinding=function(){return d===null&&g&&(d=new XRWebGLBinding(r,t)),d},this.getFrame=function(){return h},this.getSession=function(){return r},this.setSession=async function(u){if(r=u,r!==null){if(x=e.getRenderTarget(),r.addEventListener(`select`,M),r.addEventListener(`selectstart`,M),r.addEventListener(`selectend`,M),r.addEventListener(`squeeze`,M),r.addEventListener(`squeezestart`,M),r.addEventListener(`squeezeend`,M),r.addEventListener(`end`,ie),r.addEventListener(`inputsourceschange`,ae),b.xrCompatible!==!0&&await t.makeXRCompatible(),O=e.getPixelRatio(),e.getSize(ee),g&&`createProjectionLayer`in XRWebGLBinding.prototype){let n=null,a=null,o=null;b.depth&&(o=b.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,n=b.stencil?E:T,a=b.stencil?y:m);let s={colorFormat:t.RGBA8,depthFormat:o,scaleFactor:i};d=this.getBinding(),f=d.createProjectionLayer(s),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),S=new At(f.textureWidth,f.textureHeight,{format:w,type:l,depthTexture:new ri(f.textureWidth,f.textureHeight,a,void 0,void 0,void 0,void 0,void 0,void 0,n),stencilBuffer:b.stencil,colorSpace:e.outputColorSpace,samples:b.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{let n={antialias:b.antialias,alpha:!0,depth:b.depth,stencil:b.stencil,framebufferScaleFactor:i};p=new XRWebGLLayer(r,t,n),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),S=new At(p.framebufferWidth,p.framebufferHeight,{format:w,type:l,colorSpace:e.outputColorSpace,stencilBuffer:b.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(s),c=null,a=await r.requestReferenceSpace(o),fe.setContext(r),fe.start(),n.isPresenting=!0,n.dispatchEvent({type:`sessionstart`})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function ae(e){for(let t=0;t<e.removed.length;t++){let n=e.removed[t],r=D.indexOf(n);r>=0&&(D[r]=null,C[r].disconnect(n))}for(let t=0;t<e.added.length;t++){let n=e.added[t],r=D.indexOf(n);if(r===-1){for(let e=0;e<C.length;e++)if(e>=D.length){D.push(n),r=e;break}else if(D[e]===null){D[e]=n,r=e;break}if(r===-1)break}let i=C[r];i&&i.connect(n)}}let oe=new H,se=new H;function N(e,t,n){oe.setFromMatrixPosition(t.matrixWorld),se.setFromMatrixPosition(n.matrixWorld);let r=oe.distanceTo(se),i=t.projectionMatrix.elements,a=n.projectionMatrix.elements,o=i[14]/(i[10]-1),s=i[14]/(i[10]+1),c=(i[9]+1)/i[5],l=(i[9]-1)/i[5],u=(i[8]-1)/i[0],d=(a[8]+1)/a[0],f=o*u,p=o*d,m=r/(-u+d),h=m*-u;if(t.matrixWorld.decompose(e.position,e.quaternion,e.scale),e.translateX(h),e.translateZ(m),e.matrixWorld.compose(e.position,e.quaternion,e.scale),e.matrixWorldInverse.copy(e.matrixWorld).invert(),i[10]===-1)e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse);else{let t=o+m,n=s+m,i=f-h,a=p+(r-h),u=c*s/n*t,d=l*s/n*t;e.projectionMatrix.makePerspective(i,a,u,d,t,n),e.projectionMatrixInverse.copy(e.projectionMatrix).invert()}}function ce(e,t){t===null?e.matrixWorld.copy(e.matrix):e.matrixWorld.multiplyMatrices(t.matrixWorld,e.matrix),e.matrixWorldInverse.copy(e.matrixWorld).invert()}this.updateCamera=function(e){if(r===null)return;let t=e.near,n=e.far;_.texture!==null&&(_.depthNear>0&&(t=_.depthNear),_.depthFar>0&&(n=_.depthFar)),j.near=te.near=k.near=t,j.far=te.far=k.far=n,(ne!==j.near||re!==j.far)&&(r.updateRenderState({depthNear:j.near,depthFar:j.far}),ne=j.near,re=j.far),j.layers.mask=e.layers.mask|6,k.layers.mask=j.layers.mask&-5,te.layers.mask=j.layers.mask&-3;let i=e.parent,a=j.cameras;ce(j,i);for(let e=0;e<a.length;e++)ce(a[e],i);a.length===2?N(j,k,te):j.projectionMatrix.copy(k.projectionMatrix),le(e,j,i)};function le(e,t,n){n===null?e.matrix.copy(t.matrixWorld):(e.matrix.copy(n.matrixWorld),e.matrix.invert(),e.matrix.multiply(t.matrixWorld)),e.matrix.decompose(e.position,e.quaternion,e.scale),e.updateMatrixWorld(!0),e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse),e.isPerspectiveCamera&&(e.fov=it*2*Math.atan(1/e.projectionMatrix.elements[5]),e.zoom=1)}this.getCamera=function(){return j},this.getFoveation=function(){if(!(f===null&&p===null))return s},this.setFoveation=function(e){s=e,f!==null&&(f.fixedFoveation=e),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=e)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(j)},this.getCameraTexture=function(e){return v[e]};let ue=null;function de(t,i){if(u=i.getViewerPose(c||a),h=i,u!==null){let t=u.views;p!==null&&(e.setRenderTargetFramebuffer(S,p.framebuffer),e.setRenderTarget(S));let i=!1;t.length!==j.cameras.length&&(j.cameras.length=0,i=!0);for(let n=0;n<t.length;n++){let r=t[n],a=null;if(p!==null)a=p.getViewport(r);else{let t=d.getViewSubImage(f,r);a=t.viewport,n===0&&(e.setRenderTargetTextures(S,t.colorTexture,t.depthStencilTexture),e.setRenderTarget(S))}let o=A[n];o===void 0&&(o=new Zi,o.layers.enable(n),o.viewport=new Ot,A[n]=o),o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.quaternion,o.scale),o.projectionMatrix.fromArray(r.projectionMatrix),o.projectionMatrixInverse.copy(o.projectionMatrix).invert(),o.viewport.set(a.x,a.y,a.width,a.height),n===0&&(j.matrix.copy(o.matrix),j.matrix.decompose(j.position,j.quaternion,j.scale)),i===!0&&j.cameras.push(o)}let a=r.enabledFeatures;if(a&&a.includes(`depth-sensing`)&&r.depthUsage==`gpu-optimized`&&g){d=n.getBinding();let e=d.getDepthInformation(t[0]);e&&e.isValid&&e.texture&&_.init(e,r.renderState)}if(a&&a.includes(`camera-access`)&&g){e.state.unbindTexture(),d=n.getBinding();for(let e=0;e<t.length;e++){let n=t[e].camera;if(n){let e=v[n];e||(e=new ai,v[n]=e);let t=d.getCameraImage(n);e.sourceTexture=t}}}}for(let e=0;e<C.length;e++){let t=D[e],n=C[e];t!==null&&n!==void 0&&n.update(t,i,c||a)}ue&&ue(t,i),i.detectedPlanes&&n.dispatchEvent({type:`planesdetected`,data:i}),h=null}let fe=new ba;fe.setAnimationLoop(de),this.setAnimationLoop=function(e){ue=e},this.dispose=function(){}}},kc=new Nt,Ac=new U;Ac.set(-1,0,0,0,1,0,0,0,1);function jc(e,t){function n(e,t){e.matrixAutoUpdate===!0&&e.updateMatrix(),t.value.copy(e.matrix)}function r(t,n){n.color.getRGB(t.fogColor.value,mi(e)),n.isFog?(t.fogNear.value=n.near,t.fogFar.value=n.far):n.isFogExp2&&(t.fogDensity.value=n.density)}function i(e,t,n,r,i){t.isNodeMaterial?t.uniformsNeedUpdate=!1:t.isMeshBasicMaterial?a(e,t):t.isMeshLambertMaterial?(a(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshToonMaterial?(a(e,t),d(e,t)):t.isMeshPhongMaterial?(a(e,t),u(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshStandardMaterial?(a(e,t),f(e,t),t.isMeshPhysicalMaterial&&p(e,t,i)):t.isMeshMatcapMaterial?(a(e,t),m(e,t)):t.isMeshDepthMaterial?a(e,t):t.isMeshDistanceMaterial?(a(e,t),h(e,t)):t.isMeshNormalMaterial?a(e,t):t.isLineBasicMaterial?(o(e,t),t.isLineDashedMaterial&&s(e,t)):t.isPointsMaterial?c(e,t,n,r):t.isSpriteMaterial?l(e,t):t.isShadowMaterial?(e.color.value.copy(t.color),e.opacity.value=t.opacity):t.isShaderMaterial&&(t.uniformsNeedUpdate=!1)}function a(e,r){e.opacity.value=r.opacity,r.color&&e.diffuse.value.copy(r.color),r.emissive&&e.emissive.value.copy(r.emissive).multiplyScalar(r.emissiveIntensity),r.map&&(e.map.value=r.map,n(r.map,e.mapTransform)),r.alphaMap&&(e.alphaMap.value=r.alphaMap,n(r.alphaMap,e.alphaMapTransform)),r.bumpMap&&(e.bumpMap.value=r.bumpMap,n(r.bumpMap,e.bumpMapTransform),e.bumpScale.value=r.bumpScale,r.side===1&&(e.bumpScale.value*=-1)),r.normalMap&&(e.normalMap.value=r.normalMap,n(r.normalMap,e.normalMapTransform),e.normalScale.value.copy(r.normalScale),r.side===1&&e.normalScale.value.negate()),r.displacementMap&&(e.displacementMap.value=r.displacementMap,n(r.displacementMap,e.displacementMapTransform),e.displacementScale.value=r.displacementScale,e.displacementBias.value=r.displacementBias),r.emissiveMap&&(e.emissiveMap.value=r.emissiveMap,n(r.emissiveMap,e.emissiveMapTransform)),r.specularMap&&(e.specularMap.value=r.specularMap,n(r.specularMap,e.specularMapTransform)),r.alphaTest>0&&(e.alphaTest.value=r.alphaTest);let i=t.get(r),a=i.envMap,o=i.envMapRotation;a&&(e.envMap.value=a,e.envMapRotation.value.setFromMatrix4(kc.makeRotationFromEuler(o)).transpose(),a.isCubeTexture&&a.isRenderTargetTexture===!1&&e.envMapRotation.value.premultiply(Ac),e.reflectivity.value=r.reflectivity,e.ior.value=r.ior,e.refractionRatio.value=r.refractionRatio),r.lightMap&&(e.lightMap.value=r.lightMap,e.lightMapIntensity.value=r.lightMapIntensity,n(r.lightMap,e.lightMapTransform)),r.aoMap&&(e.aoMap.value=r.aoMap,e.aoMapIntensity.value=r.aoMapIntensity,n(r.aoMap,e.aoMapTransform))}function o(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform))}function s(e,t){e.dashSize.value=t.dashSize,e.totalSize.value=t.dashSize+t.gapSize,e.scale.value=t.scale}function c(e,t,r,i){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.size.value=t.size*r,e.scale.value=i*.5,t.map&&(e.map.value=t.map,n(t.map,e.uvTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function l(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.rotation.value=t.rotation,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function u(e,t){e.specular.value.copy(t.specular),e.shininess.value=Math.max(t.shininess,1e-4)}function d(e,t){t.gradientMap&&(e.gradientMap.value=t.gradientMap)}function f(e,t){e.metalness.value=t.metalness,t.metalnessMap&&(e.metalnessMap.value=t.metalnessMap,n(t.metalnessMap,e.metalnessMapTransform)),e.roughness.value=t.roughness,t.roughnessMap&&(e.roughnessMap.value=t.roughnessMap,n(t.roughnessMap,e.roughnessMapTransform)),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)}function p(e,t,r){e.ior.value=t.ior,t.sheen>0&&(e.sheenColor.value.copy(t.sheenColor).multiplyScalar(t.sheen),e.sheenRoughness.value=t.sheenRoughness,t.sheenColorMap&&(e.sheenColorMap.value=t.sheenColorMap,n(t.sheenColorMap,e.sheenColorMapTransform)),t.sheenRoughnessMap&&(e.sheenRoughnessMap.value=t.sheenRoughnessMap,n(t.sheenRoughnessMap,e.sheenRoughnessMapTransform))),t.clearcoat>0&&(e.clearcoat.value=t.clearcoat,e.clearcoatRoughness.value=t.clearcoatRoughness,t.clearcoatMap&&(e.clearcoatMap.value=t.clearcoatMap,n(t.clearcoatMap,e.clearcoatMapTransform)),t.clearcoatRoughnessMap&&(e.clearcoatRoughnessMap.value=t.clearcoatRoughnessMap,n(t.clearcoatRoughnessMap,e.clearcoatRoughnessMapTransform)),t.clearcoatNormalMap&&(e.clearcoatNormalMap.value=t.clearcoatNormalMap,n(t.clearcoatNormalMap,e.clearcoatNormalMapTransform),e.clearcoatNormalScale.value.copy(t.clearcoatNormalScale),t.side===1&&e.clearcoatNormalScale.value.negate())),t.dispersion>0&&(e.dispersion.value=t.dispersion),t.iridescence>0&&(e.iridescence.value=t.iridescence,e.iridescenceIOR.value=t.iridescenceIOR,e.iridescenceThicknessMinimum.value=t.iridescenceThicknessRange[0],e.iridescenceThicknessMaximum.value=t.iridescenceThicknessRange[1],t.iridescenceMap&&(e.iridescenceMap.value=t.iridescenceMap,n(t.iridescenceMap,e.iridescenceMapTransform)),t.iridescenceThicknessMap&&(e.iridescenceThicknessMap.value=t.iridescenceThicknessMap,n(t.iridescenceThicknessMap,e.iridescenceThicknessMapTransform))),t.transmission>0&&(e.transmission.value=t.transmission,e.transmissionSamplerMap.value=r.texture,e.transmissionSamplerSize.value.set(r.width,r.height),t.transmissionMap&&(e.transmissionMap.value=t.transmissionMap,n(t.transmissionMap,e.transmissionMapTransform)),e.thickness.value=t.thickness,t.thicknessMap&&(e.thicknessMap.value=t.thicknessMap,n(t.thicknessMap,e.thicknessMapTransform)),e.attenuationDistance.value=t.attenuationDistance,e.attenuationColor.value.copy(t.attenuationColor)),t.anisotropy>0&&(e.anisotropyVector.value.set(t.anisotropy*Math.cos(t.anisotropyRotation),t.anisotropy*Math.sin(t.anisotropyRotation)),t.anisotropyMap&&(e.anisotropyMap.value=t.anisotropyMap,n(t.anisotropyMap,e.anisotropyMapTransform))),e.specularIntensity.value=t.specularIntensity,e.specularColor.value.copy(t.specularColor),t.specularColorMap&&(e.specularColorMap.value=t.specularColorMap,n(t.specularColorMap,e.specularColorMapTransform)),t.specularIntensityMap&&(e.specularIntensityMap.value=t.specularIntensityMap,n(t.specularIntensityMap,e.specularIntensityMapTransform))}function m(e,t){t.matcap&&(e.matcap.value=t.matcap)}function h(e,n){let r=t.get(n).light;e.referencePosition.value.setFromMatrixPosition(r.matrixWorld),e.nearDistance.value=r.shadow.camera.near,e.farDistance.value=r.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:i}}function Mc(e,t,n,r){let i={},a={},o=[],s=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(e,t){let n=t.program;r.uniformBlockBinding(e,n)}function l(e,n){let o=i[e.id];o===void 0&&(m(e),o=u(e),i[e.id]=o,e.addEventListener(`dispose`,g));let s=n.program;r.updateUBOMapping(e,s);let c=t.render.frame;a[e.id]!==c&&(f(e),a[e.id]=c)}function u(t){let n=d();t.__bindingPointIndex=n;let r=e.createBuffer(),i=t.__size,a=t.usage;return e.bindBuffer(e.UNIFORM_BUFFER,r),e.bufferData(e.UNIFORM_BUFFER,i,a),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,n,r),r}function d(){for(let e=0;e<s;e++)if(o.indexOf(e)===-1)return o.push(e),e;return B(`WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached.`),0}function f(t){let n=i[t.id],r=t.uniforms,a=t.__cache;e.bindBuffer(e.UNIFORM_BUFFER,n);for(let t=0,n=r.length;t<n;t++){let n=Array.isArray(r[t])?r[t]:[r[t]];for(let r=0,i=n.length;r<i;r++){let i=n[r];if(p(i,t,r,a)===!0){let t=i.__offset,n=Array.isArray(i.value)?i.value:[i.value],r=0;for(let a=0;a<n.length;a++){let o=n[a],s=h(o);typeof o==`number`||typeof o==`boolean`?(i.__data[0]=o,e.bufferSubData(e.UNIFORM_BUFFER,t+r,i.__data)):o.isMatrix3?(i.__data[0]=o.elements[0],i.__data[1]=o.elements[1],i.__data[2]=o.elements[2],i.__data[3]=0,i.__data[4]=o.elements[3],i.__data[5]=o.elements[4],i.__data[6]=o.elements[5],i.__data[7]=0,i.__data[8]=o.elements[6],i.__data[9]=o.elements[7],i.__data[10]=o.elements[8],i.__data[11]=0):ArrayBuffer.isView(o)?i.__data.set(new o.constructor(o.buffer,o.byteOffset,i.__data.length)):(o.toArray(i.__data,r),r+=s.storage/Float32Array.BYTES_PER_ELEMENT)}e.bufferSubData(e.UNIFORM_BUFFER,t,i.__data)}}}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(e,t,n,r){let i=e.value,a=t+`_`+n;if(r[a]===void 0)return typeof i==`number`||typeof i==`boolean`?r[a]=i:ArrayBuffer.isView(i)?r[a]=i.slice():r[a]=i.clone(),!0;{let e=r[a];if(typeof i==`number`||typeof i==`boolean`){if(e!==i)return r[a]=i,!0}else if(ArrayBuffer.isView(i))return!0;else if(e.equals(i)===!1)return e.copy(i),!0}return!1}function m(e){let t=e.uniforms,n=0;for(let e=0,r=t.length;e<r;e++){let r=Array.isArray(t[e])?t[e]:[t[e]];for(let e=0,t=r.length;e<t;e++){let t=r[e],i=Array.isArray(t.value)?t.value:[t.value];for(let e=0,r=i.length;e<r;e++){let r=i[e],a=h(r),o=n%16,s=o%a.boundary,c=o+s;n+=s,c!==0&&16-c<a.storage&&(n+=16-c),t.__data=new Float32Array(a.storage/Float32Array.BYTES_PER_ELEMENT),t.__offset=n,n+=a.storage}}}let r=n%16;return r>0&&(n+=16-r),e.__size=n,e.__cache={},this}function h(e){let t={boundary:0,storage:0};return typeof e==`number`||typeof e==`boolean`?(t.boundary=4,t.storage=4):e.isVector2?(t.boundary=8,t.storage=8):e.isVector3||e.isColor?(t.boundary=16,t.storage=12):e.isVector4?(t.boundary=16,t.storage=16):e.isMatrix3?(t.boundary=48,t.storage=48):e.isMatrix4?(t.boundary=64,t.storage=64):e.isTexture?z(`WebGLRenderer: Texture samplers can not be part of an uniforms group.`):ArrayBuffer.isView(e)?(t.boundary=16,t.storage=e.byteLength):z(`WebGLRenderer: Unsupported uniform value type.`,e),t}function g(t){let n=t.target;n.removeEventListener(`dispose`,g);let r=o.indexOf(n.__bindingPointIndex);o.splice(r,1),e.deleteBuffer(i[n.id]),delete i[n.id],delete a[n.id]}function _(){for(let t in i)e.deleteBuffer(i[t]);o=[],i={},a={}}return{bind:c,update:l,dispose:_}}var Nc=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Pc=null;function Fc(){return Pc===null&&(Pc=new Lr(Nc,16,16,O,g),Pc.name=`DFG_LUT`,Pc.minFilter=o,Pc.magFilter=o,Pc.wrapS=t,Pc.wrapT=t,Pc.generateMipmaps=!1,Pc.needsUpdate=!0),Pc}var Ic=class{constructor(e={}){let{canvas:t=qe(),context:n=null,depth:r=!0,stencil:i=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:s=!0,preserveDrawingBuffer:u=!1,powerPreference:d=`default`,failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:h=!1,outputBufferType:b=l}=e;this.isWebGLRenderer=!0;let x;if(n!==null){if(typeof WebGLRenderingContext<`u`&&n instanceof WebGLRenderingContext)throw Error(`THREE.WebGLRenderer: WebGL 1 is not supported since r163.`);x=n.getContextAttributes().alpha}else x=a;let S=b,C=new Set([te,k,ee]),w=new Set([l,m,f,y,_,v]),T=new Uint32Array(4),E=new Int32Array(4),D=new H,O=null,A=null,j=[],ne=[],re=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let M=this,ie=!1,ae=null;this._outputColorSpace=Le;let oe=0,se=0,N=null,ce=-1,le=null,ue=new Ot,de=new Ot,fe=null,pe=new G(0),me=0,he=t.width,ge=t.height,_e=1,ve=null,ye=null,be=new Ot(0,0,he,ge),xe=new Ot(0,0,he,ge),Se=!1,Ce=new Gr,we=!1,Te=!1,Ee=new Nt,De=new H,Oe=new Ot,ke={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Ae=!1;function je(){return N===null?_e:1}let P=n;function Me(e,n){return t.getContext(e,n)}try{let e={alpha:!0,depth:r,stencil:i,antialias:o,premultipliedAlpha:s,preserveDrawingBuffer:u,powerPreference:d,failIfMajorPerformanceCaveat:p};if(`setAttribute`in t&&t.setAttribute(`data-engine`,`three.js r184`),t.addEventListener(`webglcontextlost`,at,!1),t.addEventListener(`webglcontextrestored`,V,!1),t.addEventListener(`webglcontextcreationerror`,ot,!1),P===null){let t=`webgl2`;if(P=Me(t,e),P===null)throw Me(t)?Error(`Error creating WebGL context with your selected attributes.`):Error(`Error creating WebGL context.`)}}catch(e){throw B(`WebGLRenderer: `+e.message),e}let F,Ne,I,Pe,L,R,Fe,Ie,Re,ze,Be,Ve,He,We,Ge,Ke,Je,Ye,Ze,Qe,et,tt,nt;function rt(){F=new $a(P),F.init(),et=new wc(P,F),Ne=new ka(P,F,e,et),I=new Sc(P,F),Ne.reversedDepthBuffer&&h&&I.buffers.depth.setReversed(!0),Pe=new no(P),L=new nc,R=new Cc(P,F,I,L,Ne,et,Pe),Fe=new Qa(M),Ie=new xa(P),tt=new Da(P,Ie),Re=new eo(P,Ie,Pe,tt),ze=new io(P,Re,Ie,tt,Pe),Ye=new ro(P,Ne,R),Ge=new Aa(L),Be=new tc(M,Fe,F,Ne,tt,Ge),Ve=new jc(M,L),He=new oc,We=new pc(F),Je=new Ea(M,Fe,I,ze,x,s),Ke=new xc(M,ze,Ne),nt=new Mc(P,Pe,Ne,I),Ze=new Oa(P,F,Pe),Qe=new to(P,F,Pe),Pe.programs=Be.programs,M.capabilities=Ne,M.extensions=F,M.properties=L,M.renderLists=He,M.shadowMap=Ke,M.state=I,M.info=Pe}rt(),S!==1009&&(re=new oo(S,t.width,t.height,r,i));let it=new Oc(M,P);this.xr=it,this.getContext=function(){return P},this.getContextAttributes=function(){return P.getContextAttributes()},this.forceContextLoss=function(){let e=F.get(`WEBGL_lose_context`);e&&e.loseContext()},this.forceContextRestore=function(){let e=F.get(`WEBGL_lose_context`);e&&e.restoreContext()},this.getPixelRatio=function(){return _e},this.setPixelRatio=function(e){e!==void 0&&(_e=e,this.setSize(he,ge,!1))},this.getSize=function(e){return e.set(he,ge)},this.setSize=function(e,n,r=!0){if(it.isPresenting){z(`WebGLRenderer: Can't change size while VR device is presenting.`);return}he=e,ge=n,t.width=Math.floor(e*_e),t.height=Math.floor(n*_e),r===!0&&(t.style.width=e+`px`,t.style.height=n+`px`),re!==null&&re.setSize(t.width,t.height),this.setViewport(0,0,e,n)},this.getDrawingBufferSize=function(e){return e.set(he*_e,ge*_e).floor()},this.setDrawingBufferSize=function(e,n,r){he=e,ge=n,_e=r,t.width=Math.floor(e*r),t.height=Math.floor(n*r),this.setViewport(0,0,e,n)},this.setEffects=function(e){if(S===1009){B(`THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.`);return}if(e){for(let t=0;t<e.length;t++)if(e[t].isOutputPass===!0){z(`THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.`);break}}re.setEffects(e||[])},this.getCurrentViewport=function(e){return e.copy(ue)},this.getViewport=function(e){return e.copy(be)},this.setViewport=function(e,t,n,r){e.isVector4?be.set(e.x,e.y,e.z,e.w):be.set(e,t,n,r),I.viewport(ue.copy(be).multiplyScalar(_e).round())},this.getScissor=function(e){return e.copy(xe)},this.setScissor=function(e,t,n,r){e.isVector4?xe.set(e.x,e.y,e.z,e.w):xe.set(e,t,n,r),I.scissor(de.copy(xe).multiplyScalar(_e).round())},this.getScissorTest=function(){return Se},this.setScissorTest=function(e){I.setScissorTest(Se=e)},this.setOpaqueSort=function(e){ve=e},this.setTransparentSort=function(e){ye=e},this.getClearColor=function(e){return e.copy(Je.getClearColor())},this.setClearColor=function(){Je.setClearColor(...arguments)},this.getClearAlpha=function(){return Je.getClearAlpha()},this.setClearAlpha=function(){Je.setClearAlpha(...arguments)},this.clear=function(e=!0,t=!0,n=!0){let r=0;if(e){let e=!1;if(N!==null){let t=N.texture.format;e=C.has(t)}if(e){let e=N.texture.type,t=w.has(e),n=Je.getClearColor(),r=Je.getClearAlpha(),i=n.r,a=n.g,o=n.b;t?(T[0]=i,T[1]=a,T[2]=o,T[3]=r,P.clearBufferuiv(P.COLOR,0,T)):(E[0]=i,E[1]=a,E[2]=o,E[3]=r,P.clearBufferiv(P.COLOR,0,E))}else r|=P.COLOR_BUFFER_BIT}t&&(r|=P.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),n&&(r|=P.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),r!==0&&P.clear(r)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(e){e.setRenderer(this),ae=e},this.dispose=function(){t.removeEventListener(`webglcontextlost`,at,!1),t.removeEventListener(`webglcontextrestored`,V,!1),t.removeEventListener(`webglcontextcreationerror`,ot,!1),Je.dispose(),He.dispose(),We.dispose(),L.dispose(),Fe.dispose(),ze.dispose(),tt.dispose(),nt.dispose(),Be.dispose(),it.dispose(),it.removeEventListener(`sessionstart`,pt),it.removeEventListener(`sessionend`,U),mt.stop()};function at(e){e.preventDefault(),Xe(`WebGLRenderer: Context Lost.`),ie=!0}function V(){Xe(`WebGLRenderer: Context Restored.`),ie=!1;let e=Pe.autoReset,t=Ke.enabled,n=Ke.autoUpdate,r=Ke.needsUpdate,i=Ke.type;rt(),Pe.autoReset=e,Ke.enabled=t,Ke.autoUpdate=n,Ke.needsUpdate=r,Ke.type=i}function ot(e){B(`WebGLRenderer: A WebGL context could not be created. Reason: `,e.statusMessage)}function st(e){let t=e.target;t.removeEventListener(`dispose`,st),ct(t)}function ct(e){lt(e),L.remove(e)}function lt(e){let t=L.get(e).programs;t!==void 0&&(t.forEach(function(e){Be.releaseProgram(e)}),e.isShaderMaterial&&Be.releaseShaderCache(e))}this.renderBufferDirect=function(e,t,n,r,i,a){t===null&&(t=ke);let o=i.isMesh&&i.matrixWorld.determinant()<0,s=wt(e,t,n,r,i);I.setMaterial(r,o);let c=n.index,l=1;if(r.wireframe===!0){if(c=Re.getWireframeAttribute(n),c===void 0)return;l=2}let u=n.drawRange,d=n.attributes.position,f=u.start*l,p=(u.start+u.count)*l;a!==null&&(f=Math.max(f,a.start*l),p=Math.min(p,(a.start+a.count)*l)),c===null?d!=null&&(f=Math.max(f,0),p=Math.min(p,d.count)):(f=Math.max(f,0),p=Math.min(p,c.count));let m=p-f;if(m<0||m===1/0)return;tt.setup(i,r,s,n,c);let h,g=Ze;if(c!==null&&(h=Ie.get(c),g=Qe,g.setIndex(h)),i.isMesh)r.wireframe===!0?(I.setLineWidth(r.wireframeLinewidth*je()),g.setMode(P.LINES)):g.setMode(P.TRIANGLES);else if(i.isLine){let e=r.linewidth;e===void 0&&(e=1),I.setLineWidth(e*je()),i.isLineSegments?g.setMode(P.LINES):i.isLineLoop?g.setMode(P.LINE_LOOP):g.setMode(P.LINE_STRIP)}else i.isPoints?g.setMode(P.POINTS):i.isSprite&&g.setMode(P.TRIANGLES);if(i.isBatchedMesh)if(F.get(`WEBGL_multi_draw`))g.renderMultiDraw(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount);else{let e=i._multiDrawStarts,t=i._multiDrawCounts,n=i._multiDrawCount,a=c?Ie.get(c).bytesPerElement:1,o=L.get(r).currentProgram.getUniforms();for(let r=0;r<n;r++)o.setValue(P,`_gl_DrawID`,r),g.render(e[r]/a,t[r])}else if(i.isInstancedMesh)g.renderInstances(f,m,i.count);else if(n.isInstancedBufferGeometry){let e=n._maxInstanceCount===void 0?1/0:n._maxInstanceCount,t=Math.min(n.instanceCount,e);g.renderInstances(f,m,t)}else g.render(f,m)};function ut(e,t,n){e.transparent===!0&&e.side===2&&e.forceSinglePass===!1?(e.side=1,e.needsUpdate=!0,bt(e,t,n),e.side=0,e.needsUpdate=!0,bt(e,t,n),e.side=2):bt(e,t,n)}this.compile=function(e,t,n=null){n===null&&(n=e),A=We.get(n),A.init(t),ne.push(A),n.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(A.pushLight(e),e.castShadow&&A.pushShadow(e))}),e!==n&&e.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(A.pushLight(e),e.castShadow&&A.pushShadow(e))}),A.setupLights();let r=new Set;return e.traverse(function(e){if(!(e.isMesh||e.isPoints||e.isLine||e.isSprite))return;let t=e.material;if(t)if(Array.isArray(t))for(let i=0;i<t.length;i++){let a=t[i];ut(a,n,e),r.add(a)}else ut(t,n,e),r.add(t)}),A=ne.pop(),r},this.compileAsync=function(e,t,n=null){let r=this.compile(e,t,n);return new Promise(t=>{function n(){if(r.forEach(function(e){L.get(e).currentProgram.isReady()&&r.delete(e)}),r.size===0){t(e);return}setTimeout(n,10)}F.get(`KHR_parallel_shader_compile`)===null?setTimeout(n,10):n()})};let dt=null;function ft(e){dt&&dt(e)}function pt(){mt.stop()}function U(){mt.start()}let mt=new ba;mt.setAnimationLoop(ft),typeof self<`u`&&mt.setContext(self),this.setAnimationLoop=function(e){dt=e,it.setAnimationLoop(e),e===null?mt.stop():mt.start()},it.addEventListener(`sessionstart`,pt),it.addEventListener(`sessionend`,U),this.render=function(e,t){if(t!==void 0&&t.isCamera!==!0){B(`WebGLRenderer.render: camera is not an instance of THREE.Camera.`);return}if(ie===!0)return;ae!==null&&ae.renderStart(e,t);let n=it.enabled===!0&&it.isPresenting===!0,r=re!==null&&(N===null||n)&&re.begin(M,N);if(e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),it.enabled===!0&&it.isPresenting===!0&&(re===null||re.isCompositing()===!1)&&(it.cameraAutoUpdate===!0&&it.updateCamera(t),t=it.getCamera()),e.isScene===!0&&e.onBeforeRender(M,e,t,N),A=We.get(e,ne.length),A.init(t),A.state.textureUnits=R.getTextureUnits(),ne.push(A),Ee.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),Ce.setFromProjectionMatrix(Ee,Ue,t.reversedDepth),Te=this.localClippingEnabled,we=Ge.init(this.clippingPlanes,Te),O=He.get(e,j.length),O.init(),j.push(O),it.enabled===!0&&it.isPresenting===!0){let e=M.xr.getDepthSensingMesh();e!==null&&ht(e,t,-1/0,M.sortObjects)}ht(e,t,0,M.sortObjects),O.finish(),M.sortObjects===!0&&O.sort(ve,ye),Ae=it.enabled===!1||it.isPresenting===!1||it.hasDepthSensing()===!1,Ae&&Je.addToRenderList(O,e),this.info.render.frame++,we===!0&&Ge.beginShadows();let i=A.state.shadowsArray;if(Ke.render(i,e,t),we===!0&&Ge.endShadows(),this.info.autoReset===!0&&this.info.reset(),(r&&re.hasRenderPass())===!1){let n=O.opaque,r=O.transmissive;if(A.setupLights(),t.isArrayCamera){let i=t.cameras;if(r.length>0)for(let t=0,a=i.length;t<a;t++){let a=i[t];_t(n,r,e,a)}Ae&&Je.render(e);for(let t=0,n=i.length;t<n;t++){let n=i[t];gt(O,e,n,n.viewport)}}else r.length>0&&_t(n,r,e,t),Ae&&Je.render(e),gt(O,e,t)}N!==null&&se===0&&(R.updateMultisampleRenderTarget(N),R.updateRenderTargetMipmap(N)),r&&re.end(M),e.isScene===!0&&e.onAfterRender(M,e,t),tt.resetDefaultState(),ce=-1,le=null,ne.pop(),ne.length>0?(A=ne[ne.length-1],R.setTextureUnits(A.state.textureUnits),we===!0&&Ge.setGlobalState(M.clippingPlanes,A.state.camera)):A=null,j.pop(),O=j.length>0?j[j.length-1]:null,ae!==null&&ae.renderEnd()};function ht(e,t,n,r){if(e.visible===!1)return;if(e.layers.test(t.layers)){if(e.isGroup)n=e.renderOrder;else if(e.isLOD)e.autoUpdate===!0&&e.update(t);else if(e.isLightProbeGrid)A.pushLightProbeGrid(e);else if(e.isLight)A.pushLight(e),e.castShadow&&A.pushShadow(e);else if(e.isSprite){if(!e.frustumCulled||Ce.intersectsSprite(e)){r&&Oe.setFromMatrixPosition(e.matrixWorld).applyMatrix4(Ee);let t=ze.update(e),i=e.material;i.visible&&O.push(e,t,i,n,Oe.z,null)}}else if((e.isMesh||e.isLine||e.isPoints)&&(!e.frustumCulled||Ce.intersectsObject(e))){let t=ze.update(e),i=e.material;if(r&&(e.boundingSphere===void 0?(t.boundingSphere===null&&t.computeBoundingSphere(),Oe.copy(t.boundingSphere.center)):(e.boundingSphere===null&&e.computeBoundingSphere(),Oe.copy(e.boundingSphere.center)),Oe.applyMatrix4(e.matrixWorld).applyMatrix4(Ee)),Array.isArray(i)){let r=t.groups;for(let a=0,o=r.length;a<o;a++){let o=r[a],s=i[o.materialIndex];s&&s.visible&&O.push(e,t,s,n,Oe.z,o)}}else i.visible&&O.push(e,t,i,n,Oe.z,null)}}let i=e.children;for(let e=0,a=i.length;e<a;e++)ht(i[e],t,n,r)}function gt(e,t,n,r){let{opaque:i,transmissive:a,transparent:o}=e;A.setupLightsView(n),we===!0&&Ge.setGlobalState(M.clippingPlanes,n),r&&I.viewport(ue.copy(r)),i.length>0&&vt(i,t,n),a.length>0&&vt(a,t,n),o.length>0&&vt(o,t,n),I.buffers.depth.setTest(!0),I.buffers.depth.setMask(!0),I.buffers.color.setMask(!0),I.setPolygonOffset(!1)}function _t(e,t,n,r){if((n.isScene===!0?n.overrideMaterial:null)!==null)return;if(A.state.transmissionRenderTarget[r.id]===void 0){let e=F.has(`EXT_color_buffer_half_float`)||F.has(`EXT_color_buffer_float`);A.state.transmissionRenderTarget[r.id]=new At(1,1,{generateMipmaps:!0,type:e?g:l,minFilter:c,samples:Math.max(4,Ne.samples),stencilBuffer:i,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:W.workingColorSpace})}let a=A.state.transmissionRenderTarget[r.id],o=r.viewport||ue;a.setSize(o.z*M.transmissionResolutionScale,o.w*M.transmissionResolutionScale);let s=M.getRenderTarget(),u=M.getActiveCubeFace(),d=M.getActiveMipmapLevel();M.setRenderTarget(a),M.getClearColor(pe),me=M.getClearAlpha(),me<1&&M.setClearColor(16777215,.5),M.clear(),Ae&&Je.render(n);let f=M.toneMapping;M.toneMapping=0;let p=r.viewport;if(r.viewport!==void 0&&(r.viewport=void 0),A.setupLightsView(r),we===!0&&Ge.setGlobalState(M.clippingPlanes,r),vt(e,n,r),R.updateMultisampleRenderTarget(a),R.updateRenderTargetMipmap(a),F.has(`WEBGL_multisampled_render_to_texture`)===!1){let e=!1;for(let i=0,a=t.length;i<a;i++){let{object:a,geometry:o,material:s,group:c}=t[i];if(s.side===2&&a.layers.test(r.layers)){let t=s.side;s.side=1,s.needsUpdate=!0,yt(a,n,r,o,s,c),s.side=t,s.needsUpdate=!0,e=!0}}e===!0&&(R.updateMultisampleRenderTarget(a),R.updateRenderTargetMipmap(a))}M.setRenderTarget(s,u,d),M.setClearColor(pe,me),p!==void 0&&(r.viewport=p),M.toneMapping=f}function vt(e,t,n){let r=t.isScene===!0?t.overrideMaterial:null;for(let i=0,a=e.length;i<a;i++){let a=e[i],{object:o,geometry:s,group:c}=a,l=a.material;l.allowOverride===!0&&r!==null&&(l=r),o.layers.test(n.layers)&&yt(o,t,n,s,l,c)}}function yt(e,t,n,r,i,a){e.onBeforeRender(M,t,n,r,i,a),e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse,e.matrixWorld),e.normalMatrix.getNormalMatrix(e.modelViewMatrix),i.onBeforeRender(M,t,n,r,e,a),i.transparent===!0&&i.side===2&&i.forceSinglePass===!1?(i.side=1,i.needsUpdate=!0,M.renderBufferDirect(n,t,r,i,e,a),i.side=0,i.needsUpdate=!0,M.renderBufferDirect(n,t,r,i,e,a),i.side=2):M.renderBufferDirect(n,t,r,i,e,a),e.onAfterRender(M,t,n,r,i,a)}function bt(e,t,n){t.isScene!==!0&&(t=ke);let r=L.get(e),i=A.state.lights,a=A.state.shadowsArray,o=i.state.version,s=Be.getParameters(e,i.state,a,t,n,A.state.lightProbeGridArray),c=Be.getProgramCacheKey(s),l=r.programs;r.environment=e.isMeshStandardMaterial||e.isMeshLambertMaterial||e.isMeshPhongMaterial?t.environment:null,r.fog=t.fog;let u=e.isMeshStandardMaterial||e.isMeshLambertMaterial&&!e.envMap||e.isMeshPhongMaterial&&!e.envMap;r.envMap=Fe.get(e.envMap||r.environment,u),r.envMapRotation=r.environment!==null&&e.envMap===null?t.environmentRotation:e.envMapRotation,l===void 0&&(e.addEventListener(`dispose`,st),l=new Map,r.programs=l);let d=l.get(c);if(d!==void 0){if(r.currentProgram===d&&r.lightsStateVersion===o)return St(e,s),d}else s.uniforms=Be.getUniforms(e),ae!==null&&e.isNodeMaterial&&ae.build(e,n,s),e.onBeforeCompile(s,M),d=Be.acquireProgram(s,c),l.set(c,d),r.uniforms=s.uniforms;let f=r.uniforms;return(!e.isShaderMaterial&&!e.isRawShaderMaterial||e.clipping===!0)&&(f.clippingPlanes=Ge.uniform),St(e,s),r.needsLights=Et(e),r.lightsStateVersion=o,r.needsLights&&(f.ambientLightColor.value=i.state.ambient,f.lightProbe.value=i.state.probe,f.directionalLights.value=i.state.directional,f.directionalLightShadows.value=i.state.directionalShadow,f.spotLights.value=i.state.spot,f.spotLightShadows.value=i.state.spotShadow,f.rectAreaLights.value=i.state.rectArea,f.ltc_1.value=i.state.rectAreaLTC1,f.ltc_2.value=i.state.rectAreaLTC2,f.pointLights.value=i.state.point,f.pointLightShadows.value=i.state.pointShadow,f.hemisphereLights.value=i.state.hemi,f.directionalShadowMatrix.value=i.state.directionalShadowMatrix,f.spotLightMatrix.value=i.state.spotLightMatrix,f.spotLightMap.value=i.state.spotLightMap,f.pointShadowMatrix.value=i.state.pointShadowMatrix),r.lightProbeGrid=A.state.lightProbeGridArray.length>0,r.currentProgram=d,r.uniformsList=null,d}function xt(e){if(e.uniformsList===null){let t=e.currentProgram.getUniforms();e.uniformsList=ms.seqWithValue(t.seq,e.uniforms)}return e.uniformsList}function St(e,t){let n=L.get(e);n.outputColorSpace=t.outputColorSpace,n.batching=t.batching,n.batchingColor=t.batchingColor,n.instancing=t.instancing,n.instancingColor=t.instancingColor,n.instancingMorph=t.instancingMorph,n.skinning=t.skinning,n.morphTargets=t.morphTargets,n.morphNormals=t.morphNormals,n.morphColors=t.morphColors,n.morphTargetsCount=t.morphTargetsCount,n.numClippingPlanes=t.numClippingPlanes,n.numIntersection=t.numClipIntersection,n.vertexAlphas=t.vertexAlphas,n.vertexTangents=t.vertexTangents,n.toneMapping=t.toneMapping}function Ct(e,t){if(e.length===0)return null;if(e.length===1)return e[0].texture===null?null:e[0];D.setFromMatrixPosition(t.matrixWorld);for(let t=0,n=e.length;t<n;t++){let n=e[t];if(n.texture!==null&&n.boundingBox.containsPoint(D))return n}return null}function wt(e,t,n,r,i){t.isScene!==!0&&(t=ke),R.resetTextureUnits();let a=t.fog,o=r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial?t.environment:null,s=N===null?M.outputColorSpace:N.isXRRenderTarget===!0?N.texture.colorSpace:W.workingColorSpace,c=r.isMeshStandardMaterial||r.isMeshLambertMaterial&&!r.envMap||r.isMeshPhongMaterial&&!r.envMap,l=Fe.get(r.envMap||o,c),u=r.vertexColors===!0&&!!n.attributes.color&&n.attributes.color.itemSize===4,d=!!n.attributes.tangent&&(!!r.normalMap||r.anisotropy>0),f=!!n.morphAttributes.position,p=!!n.morphAttributes.normal,m=!!n.morphAttributes.color,h=0;r.toneMapped&&(N===null||N.isXRRenderTarget===!0)&&(h=M.toneMapping);let g=n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color,_=g===void 0?0:g.length,v=L.get(r),y=A.state.lights;if(we===!0&&(Te===!0||e!==le)){let t=e===le&&r.id===ce;Ge.setState(r,e,t)}let b=!1;r.version===v.__version?v.needsLights&&v.lightsStateVersion!==y.state.version?b=!0:v.outputColorSpace===s?i.isBatchedMesh&&v.batching===!1||!i.isBatchedMesh&&v.batching===!0||i.isBatchedMesh&&v.batchingColor===!0&&i.colorTexture===null||i.isBatchedMesh&&v.batchingColor===!1&&i.colorTexture!==null||i.isInstancedMesh&&v.instancing===!1||!i.isInstancedMesh&&v.instancing===!0||i.isSkinnedMesh&&v.skinning===!1||!i.isSkinnedMesh&&v.skinning===!0||i.isInstancedMesh&&v.instancingColor===!0&&i.instanceColor===null||i.isInstancedMesh&&v.instancingColor===!1&&i.instanceColor!==null||i.isInstancedMesh&&v.instancingMorph===!0&&i.morphTexture===null||i.isInstancedMesh&&v.instancingMorph===!1&&i.morphTexture!==null?b=!0:v.envMap===l?r.fog===!0&&v.fog!==a||v.numClippingPlanes!==void 0&&(v.numClippingPlanes!==Ge.numPlanes||v.numIntersection!==Ge.numIntersection)?b=!0:v.vertexAlphas===u&&v.vertexTangents===d&&v.morphTargets===f&&v.morphNormals===p&&v.morphColors===m&&v.toneMapping===h&&v.morphTargetsCount===_?!!v.lightProbeGrid!=A.state.lightProbeGridArray.length>0&&(b=!0):b=!0:b=!0:b=!0:(b=!0,v.__version=r.version);let x=v.currentProgram;b===!0&&(x=bt(r,t,i),ae&&r.isNodeMaterial&&ae.onUpdateProgram(r,x,v));let S=!1,C=!1,w=!1,T=x.getUniforms(),E=v.uniforms;if(I.useProgram(x.program)&&(S=!0,C=!0,w=!0),r.id!==ce&&(ce=r.id,C=!0),v.needsLights){let e=Ct(A.state.lightProbeGridArray,i);v.lightProbeGrid!==e&&(v.lightProbeGrid=e,C=!0)}if(S||le!==e){I.buffers.depth.getReversed()&&e.reversedDepth!==!0&&(e._reversedDepth=!0,e.updateProjectionMatrix()),T.setValue(P,`projectionMatrix`,e.projectionMatrix),T.setValue(P,`viewMatrix`,e.matrixWorldInverse);let t=T.map.cameraPosition;t!==void 0&&t.setValue(P,De.setFromMatrixPosition(e.matrixWorld)),Ne.logarithmicDepthBuffer&&T.setValue(P,`logDepthBufFC`,2/(Math.log(e.far+1)/Math.LN2)),(r.isMeshPhongMaterial||r.isMeshToonMaterial||r.isMeshLambertMaterial||r.isMeshBasicMaterial||r.isMeshStandardMaterial||r.isShaderMaterial)&&T.setValue(P,`isOrthographic`,e.isOrthographicCamera===!0),le!==e&&(le=e,C=!0,w=!0)}if(v.needsLights&&(y.state.directionalShadowMap.length>0&&T.setValue(P,`directionalShadowMap`,y.state.directionalShadowMap,R),y.state.spotShadowMap.length>0&&T.setValue(P,`spotShadowMap`,y.state.spotShadowMap,R),y.state.pointShadowMap.length>0&&T.setValue(P,`pointShadowMap`,y.state.pointShadowMap,R)),i.isSkinnedMesh){T.setOptional(P,i,`bindMatrix`),T.setOptional(P,i,`bindMatrixInverse`);let e=i.skeleton;e&&(e.boneTexture===null&&e.computeBoneTexture(),T.setValue(P,`boneTexture`,e.boneTexture,R))}i.isBatchedMesh&&(T.setOptional(P,i,`batchingTexture`),T.setValue(P,`batchingTexture`,i._matricesTexture,R),T.setOptional(P,i,`batchingIdTexture`),T.setValue(P,`batchingIdTexture`,i._indirectTexture,R),T.setOptional(P,i,`batchingColorTexture`),i._colorsTexture!==null&&T.setValue(P,`batchingColorTexture`,i._colorsTexture,R));let D=n.morphAttributes;if((D.position!==void 0||D.normal!==void 0||D.color!==void 0)&&Ye.update(i,n,x),(C||v.receiveShadow!==i.receiveShadow)&&(v.receiveShadow=i.receiveShadow,T.setValue(P,`receiveShadow`,i.receiveShadow)),(r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial)&&r.envMap===null&&t.environment!==null&&(E.envMapIntensity.value=t.environmentIntensity),E.dfgLUT!==void 0&&(E.dfgLUT.value=Fc()),C){if(T.setValue(P,`toneMappingExposure`,M.toneMappingExposure),v.needsLights&&Tt(E,w),a&&r.fog===!0&&Ve.refreshFogUniforms(E,a),Ve.refreshMaterialUniforms(E,r,_e,ge,A.state.transmissionRenderTarget[e.id]),v.needsLights&&v.lightProbeGrid){let e=v.lightProbeGrid;E.probesSH.value=e.texture,E.probesMin.value.copy(e.boundingBox.min),E.probesMax.value.copy(e.boundingBox.max),E.probesResolution.value.copy(e.resolution)}ms.upload(P,xt(v),E,R)}if(r.isShaderMaterial&&r.uniformsNeedUpdate===!0&&(ms.upload(P,xt(v),E,R),r.uniformsNeedUpdate=!1),r.isSpriteMaterial&&T.setValue(P,`center`,i.center),T.setValue(P,`modelViewMatrix`,i.modelViewMatrix),T.setValue(P,`normalMatrix`,i.normalMatrix),T.setValue(P,`modelMatrix`,i.matrixWorld),r.uniformsGroups!==void 0){let e=r.uniformsGroups;for(let t=0,n=e.length;t<n;t++){let n=e[t];nt.update(n,x),nt.bind(n,x)}}return x}function Tt(e,t){e.ambientLightColor.needsUpdate=t,e.lightProbe.needsUpdate=t,e.directionalLights.needsUpdate=t,e.directionalLightShadows.needsUpdate=t,e.pointLights.needsUpdate=t,e.pointLightShadows.needsUpdate=t,e.spotLights.needsUpdate=t,e.spotLightShadows.needsUpdate=t,e.rectAreaLights.needsUpdate=t,e.hemisphereLights.needsUpdate=t}function Et(e){return e.isMeshLambertMaterial||e.isMeshToonMaterial||e.isMeshPhongMaterial||e.isMeshStandardMaterial||e.isShadowMaterial||e.isShaderMaterial&&e.lights===!0}this.getActiveCubeFace=function(){return oe},this.getActiveMipmapLevel=function(){return se},this.getRenderTarget=function(){return N},this.setRenderTargetTextures=function(e,t,n){let r=L.get(e);r.__autoAllocateDepthBuffer=e.resolveDepthBuffer===!1,r.__autoAllocateDepthBuffer===!1&&(r.__useRenderToTexture=!1),L.get(e.texture).__webglTexture=t,L.get(e.depthTexture).__webglTexture=r.__autoAllocateDepthBuffer?void 0:n,r.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(e,t){let n=L.get(e);n.__webglFramebuffer=t,n.__useDefaultFramebuffer=t===void 0};let Dt=P.createFramebuffer();this.setRenderTarget=function(e,t=0,n=0){N=e,oe=t,se=n;let r=null,i=!1,a=!1;if(e){let o=L.get(e);if(o.__useDefaultFramebuffer!==void 0){I.bindFramebuffer(P.FRAMEBUFFER,o.__webglFramebuffer),ue.copy(e.viewport),de.copy(e.scissor),fe=e.scissorTest,I.viewport(ue),I.scissor(de),I.setScissorTest(fe),ce=-1;return}else if(o.__webglFramebuffer===void 0)R.setupRenderTarget(e);else if(o.__hasExternalTextures)R.rebindTextures(e,L.get(e.texture).__webglTexture,L.get(e.depthTexture).__webglTexture);else if(e.depthBuffer){let t=e.depthTexture;if(o.__boundDepthTexture!==t){if(t!==null&&L.has(t)&&(e.width!==t.image.width||e.height!==t.image.height))throw Error(`WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.`);R.setupDepthRenderbuffer(e)}}let s=e.texture;(s.isData3DTexture||s.isDataArrayTexture||s.isCompressedArrayTexture)&&(a=!0);let c=L.get(e).__webglFramebuffer;e.isWebGLCubeRenderTarget?(r=Array.isArray(c[t])?c[t][n]:c[t],i=!0):r=e.samples>0&&R.useMultisampledRTT(e)===!1?L.get(e).__webglMultisampledFramebuffer:Array.isArray(c)?c[n]:c,ue.copy(e.viewport),de.copy(e.scissor),fe=e.scissorTest}else ue.copy(be).multiplyScalar(_e).floor(),de.copy(xe).multiplyScalar(_e).floor(),fe=Se;if(n!==0&&(r=Dt),I.bindFramebuffer(P.FRAMEBUFFER,r)&&I.drawBuffers(e,r),I.viewport(ue),I.scissor(de),I.setScissorTest(fe),i){let r=L.get(e.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_CUBE_MAP_POSITIVE_X+t,r.__webglTexture,n)}else if(a){let r=t;for(let t=0;t<e.textures.length;t++){let i=L.get(e.textures[t]);P.framebufferTextureLayer(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0+t,i.__webglTexture,n,r)}}else if(e!==null&&n!==0){let t=L.get(e.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,t.__webglTexture,n)}ce=-1},this.readRenderTargetPixels=function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget)){B(`WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);return}let c=L.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){I.bindFramebuffer(P.FRAMEBUFFER,c);try{let o=e.textures[s],c=o.format,l=o.type;if(e.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+s),!Ne.textureFormatReadable(c)){B(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.`);return}if(!Ne.textureTypeReadable(l)){B(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.`);return}t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i&&P.readPixels(t,n,r,i,et.convert(c),et.convert(l),a)}finally{let e=N===null?null:L.get(N).__webglFramebuffer;I.bindFramebuffer(P.FRAMEBUFFER,e)}}},this.readRenderTargetPixelsAsync=async function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget))throw Error(`THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);let c=L.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c)if(t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i){I.bindFramebuffer(P.FRAMEBUFFER,c);let o=e.textures[s],l=o.format,u=o.type;if(e.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+s),!Ne.textureFormatReadable(l))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.`);if(!Ne.textureTypeReadable(u))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.`);let d=P.createBuffer();P.bindBuffer(P.PIXEL_PACK_BUFFER,d),P.bufferData(P.PIXEL_PACK_BUFFER,a.byteLength,P.STREAM_READ),P.readPixels(t,n,r,i,et.convert(l),et.convert(u),0);let f=N===null?null:L.get(N).__webglFramebuffer;I.bindFramebuffer(P.FRAMEBUFFER,f);let p=P.fenceSync(P.SYNC_GPU_COMMANDS_COMPLETE,0);return P.flush(),await $e(P,p,4),P.bindBuffer(P.PIXEL_PACK_BUFFER,d),P.getBufferSubData(P.PIXEL_PACK_BUFFER,0,a),P.deleteBuffer(d),P.deleteSync(p),a}else throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.`)},this.copyFramebufferToTexture=function(e,t=null,n=0){let r=2**-n,i=Math.floor(e.image.width*r),a=Math.floor(e.image.height*r),o=t===null?0:t.x,s=t===null?0:t.y;R.setTexture2D(e,0),P.copyTexSubImage2D(P.TEXTURE_2D,n,0,0,o,s,i,a),I.unbindTexture()};let kt=P.createFramebuffer(),jt=P.createFramebuffer();this.copyTextureToTexture=function(e,t,n=null,r=null,i=0,a=0){let o,s,c,l,u,d,f,p,m,h=e.isCompressedTexture?e.mipmaps[a]:e.image;if(n!==null)o=n.max.x-n.min.x,s=n.max.y-n.min.y,c=n.isBox3?n.max.z-n.min.z:1,l=n.min.x,u=n.min.y,d=n.isBox3?n.min.z:0;else{let t=2**-i;o=Math.floor(h.width*t),s=Math.floor(h.height*t),c=e.isDataArrayTexture?h.depth:e.isData3DTexture?Math.floor(h.depth*t):1,l=0,u=0,d=0}r===null?(f=0,p=0,m=0):(f=r.x,p=r.y,m=r.z);let g=et.convert(t.format),_=et.convert(t.type),v;t.isData3DTexture?(R.setTexture3D(t,0),v=P.TEXTURE_3D):t.isDataArrayTexture||t.isCompressedArrayTexture?(R.setTexture2DArray(t,0),v=P.TEXTURE_2D_ARRAY):(R.setTexture2D(t,0),v=P.TEXTURE_2D),I.activeTexture(P.TEXTURE0),I.pixelStorei(P.UNPACK_FLIP_Y_WEBGL,t.flipY),I.pixelStorei(P.UNPACK_PREMULTIPLY_ALPHA_WEBGL,t.premultiplyAlpha),I.pixelStorei(P.UNPACK_ALIGNMENT,t.unpackAlignment);let y=I.getParameter(P.UNPACK_ROW_LENGTH),b=I.getParameter(P.UNPACK_IMAGE_HEIGHT),x=I.getParameter(P.UNPACK_SKIP_PIXELS),S=I.getParameter(P.UNPACK_SKIP_ROWS),C=I.getParameter(P.UNPACK_SKIP_IMAGES);I.pixelStorei(P.UNPACK_ROW_LENGTH,h.width),I.pixelStorei(P.UNPACK_IMAGE_HEIGHT,h.height),I.pixelStorei(P.UNPACK_SKIP_PIXELS,l),I.pixelStorei(P.UNPACK_SKIP_ROWS,u),I.pixelStorei(P.UNPACK_SKIP_IMAGES,d);let w=e.isDataArrayTexture||e.isData3DTexture,T=t.isDataArrayTexture||t.isData3DTexture;if(e.isDepthTexture){let n=L.get(e),r=L.get(t),h=L.get(n.__renderTarget),g=L.get(r.__renderTarget);I.bindFramebuffer(P.READ_FRAMEBUFFER,h.__webglFramebuffer),I.bindFramebuffer(P.DRAW_FRAMEBUFFER,g.__webglFramebuffer);for(let n=0;n<c;n++)w&&(P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,L.get(e).__webglTexture,i,d+n),P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,L.get(t).__webglTexture,a,m+n)),P.blitFramebuffer(l,u,o,s,f,p,o,s,P.DEPTH_BUFFER_BIT,P.NEAREST);I.bindFramebuffer(P.READ_FRAMEBUFFER,null),I.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else if(i!==0||e.isRenderTargetTexture||L.has(e)){let n=L.get(e),r=L.get(t);I.bindFramebuffer(P.READ_FRAMEBUFFER,kt),I.bindFramebuffer(P.DRAW_FRAMEBUFFER,jt);for(let e=0;e<c;e++)w?P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,n.__webglTexture,i,d+e):P.framebufferTexture2D(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,n.__webglTexture,i),T?P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,r.__webglTexture,a,m+e):P.framebufferTexture2D(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,r.__webglTexture,a),i===0?T?P.copyTexSubImage3D(v,a,f,p,m+e,l,u,o,s):P.copyTexSubImage2D(v,a,f,p,l,u,o,s):P.blitFramebuffer(l,u,o,s,f,p,o,s,P.COLOR_BUFFER_BIT,P.NEAREST);I.bindFramebuffer(P.READ_FRAMEBUFFER,null),I.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else T?e.isDataTexture||e.isData3DTexture?P.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h.data):t.isCompressedArrayTexture?P.compressedTexSubImage3D(v,a,f,p,m,o,s,c,g,h.data):P.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h):e.isDataTexture?P.texSubImage2D(P.TEXTURE_2D,a,f,p,o,s,g,_,h.data):e.isCompressedTexture?P.compressedTexSubImage2D(P.TEXTURE_2D,a,f,p,h.width,h.height,g,h.data):P.texSubImage2D(P.TEXTURE_2D,a,f,p,o,s,g,_,h);I.pixelStorei(P.UNPACK_ROW_LENGTH,y),I.pixelStorei(P.UNPACK_IMAGE_HEIGHT,b),I.pixelStorei(P.UNPACK_SKIP_PIXELS,x),I.pixelStorei(P.UNPACK_SKIP_ROWS,S),I.pixelStorei(P.UNPACK_SKIP_IMAGES,C),a===0&&t.generateMipmaps&&P.generateMipmap(v),I.unbindTexture()},this.initRenderTarget=function(e){L.get(e).__webglFramebuffer===void 0&&R.setupRenderTarget(e)},this.initTexture=function(e){e.isCubeTexture?R.setTextureCube(e,0):e.isData3DTexture?R.setTexture3D(e,0):e.isDataArrayTexture||e.isCompressedArrayTexture?R.setTexture2DArray(e,0):R.setTexture2D(e,0),I.unbindTexture()},this.resetState=function(){oe=0,se=0,N=null,I.reset(),tt.reset()},typeof __THREE_DEVTOOLS__<`u`&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`observe`,{detail:this}))}get coordinateSystem(){return Ue}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=W._getDrawingBufferColorSpace(e),t.unpackColorSpace=W._getUnpackColorSpace()}},Lc=`inner-orbit-v2-sessions`,Rc=`inner-orbit-v2-voice-guide`,zc=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,Bc=28e3,Vc=18e3,Hc=[{key:`present`,name:`Present`,duration:5200,hold:.12},{key:`opposite`,name:`Opposite`,duration:5600,hold:.2},{key:`include`,name:`Include`,duration:5600,hold:.42},{key:`hold`,name:`Hold both`,duration:3800,hold:1}],Uc={box:{label:`4 4 4 4`,phases:[{key:`inhale`,name:`Inhale`,duration:4e3},{key:`pause`,name:`Pause`,duration:4e3},{key:`exhale`,name:`Exhale`,duration:4e3},{key:`rest`,name:`Rest`,duration:4e3}]},calm:{label:`4 2 6 2`,phases:[{key:`inhale`,name:`Inhale`,duration:4e3},{key:`pause`,name:`Pause`,duration:2e3},{key:`exhale`,name:`Exhale`,duration:6e3},{key:`rest`,name:`Rest`,duration:2e3}]},deep:{label:`5 5 7 3`,phases:[{key:`inhale`,name:`Inhale`,duration:5e3},{key:`pause`,name:`Pause`,duration:5e3},{key:`exhale`,name:`Exhale`,duration:7e3},{key:`rest`,name:`Rest`,duration:3e3}]},release:{label:`4 7 8 1`,phases:[{key:`inhale`,name:`Inhale`,duration:4e3},{key:`pause`,name:`Pause`,duration:7e3},{key:`exhale`,name:`Exhale`,duration:8e3},{key:`rest`,name:`Rest`,duration:1e3}]}},Wc={present:`First, establish what is present. Let the copper movement carry the formed pattern: the feeling, thought, memory, or self-referential loop that is already here.`,opposite:`Now establish the opposite, or what has not yet been given shape. Let the blue movement carry the wider field of possibility without forcing it to become an answer.`,orbs:`Watch the motions as two readings of one inner field. One is familiar and formed. One is emerging and open. Neither has to erase the other.`,field:`When the whole image brightens, practice the center. Notice the angle of seeing. You may begin inside the loop, then recognize the loop inside awareness.`,breath:`If you choose Breath mode, let the rhythm be gentle. Inhale with the blue movement, pause as the ring shines, exhale with the copper loop, and rest without trying to fix anything.`},Gc={present:`present`,opposite:`opposite`,orbs:`orbs`,field:`field`,breath:`breath`},Kc=[`present`,`opposite`,`orbs`,`field`],qc=[`present`,`opposite`,`orbs`,`field`,`breath`],Jc={present:`audio/PRESENT.mp3`,opposite:`audio/OPPOSITE.mp3`,orbs:`audio/ORBS.mp3`,field:`audio/FIELD.mp3`,breath:`audio/BREATH.mp3`},Yc=[[`what`,`What this is`],[`you`,`What it means in you`],[`use`,`How to use it`],[`connect`,`How it connects`]],Xc={landing:{kicker:`Orientation`,title:`Tone Paradox at a glance`,summary:`The app is a symbolic practice for holding a formed state and its opposite in one living field.`,what:`You are looking at a symbolic lens of attention: a copper loop, a blue open field, and a pale-gold meeting ring.`,you:`For the person using it, the first word names what already feels formed. The second word names what may also be true, possible, hidden, or not yet embodied.`,use:`Begin by naming the two poles. Then let the animation carry them so attention can practice seeing both without needing an immediate answer.`,connect:`Copper maps to the conscious, self-referential loop. Blue maps to the wider, unformed field. Gold marks the mirror point where both can be held without collapse.`},setup:{kicker:`Setup`,title:`Naming the two poles`,summary:`This is where the abstract geometry becomes personal to the person doing the practice.`,what:`The setup asks for two pieces of inner data: what is present now, and what is also true or opposite.`,you:`For you right now, {{poleOne}} becomes the formed state carried by copper. {{poleTwo}} becomes the wider possibility carried by blue.`,use:`Keep the words honest and simple. They do not need to be perfect. The practice works better when the words are close to what is actually alive.`,connect:`This mirrors the toroid and hyperboloid idea: one side is the known loop, the other side is the open field that has not fully taken shape yet.`},practice:{kicker:`Practice`,title:`Watching both as one field`,summary:`The animation is an anchor for attention, not a measurement of your mind.`,what:`The copper motion carries {{poleOne}} as the formed pattern. The blue motion carries {{poleTwo}} as the opposite or wider field. The gold ring marks contact.`,you:`For the person practicing, the point is not to become positive. It is to stop making one side erase the other, then notice whether the angle of perception changes.`,use:`Let the orbs move. Let the words stay simple. When attention wanders, return to seeing {{poleOne}} and {{poleTwo}} in the same image.`,connect:`This is the practical version of the geometry: conscious self-reference, unconscious possibility, and a focal ring where both are observed together.`},present:{kicker:`Phase 01`,title:`Present: the formed state`,summary:`{{poleOne}} is treated as the state that already has shape.`,what:`This phase emphasizes the copper toroidal movement. It represents the conscious, self-referential pattern that is already here.`,you:`Whatever word you chose, the app treats {{poleOne}} as the known pattern currently repeating or organizing attention.`,use:`Do not push it away. Watch it as a formed loop. Let the body and mind admit: this is here.`,connect:`The toroid returns to itself, so it is used as a symbol for familiar loops: story, identity, category, memory, and self-reference.`},opposite:{kicker:`Phase 02`,title:`Opposite: the wider field`,summary:`{{poleTwo}} is invited as what is also possible, hidden, or not yet formed.`,what:`This phase emphasizes the blue hyperboloid and its moving orbs. It represents the unformed opposite field.`,you:`For the person practicing, {{poleTwo}} is not a forced replacement for {{poleOne}}. It is a possibility that is allowed to enter the field.`,use:`Let the opposite appear lightly. You are not trying to believe it with force. You are giving it enough room to be seen.`,connect:`The hyperboloid opens outward, so it is used as a symbol for possibility beyond the current category or self-referential loop.`},include:{kicker:`Phase 03`,title:`Include: both visible`,summary:`This phase trains the mind to see {{poleOne}} and {{poleTwo}} together.`,what:`Copper and blue both become more present. The app is showing the formed pattern and the opposite field at the same time.`,you:`For the person practicing, this is where paradox becomes experiential: the difficult state can be here, and the opposite can also be here.`,use:`Look back and forth between the two motions, then soften into the whole image. You do not need to decide which side is more true.`,connect:`This is the bridge between the two geometries. The app is not resolving the paradox; it is making room for the two readings to coexist.`},hold:{kicker:`Phase 04`,title:`Hold: shift the angle`,summary:`The gold focal ring marks the moment where neither side has to disappear.`,what:`The hold phase brightens the whole structure. The focal ring becomes the visual center of coexistence and the mirror point where the two readings meet.`,you:`For the person practicing, this is the felt sense of: {{poleOne}} is here, {{poleTwo}} is also here, and I can observe the field instead of being only inside one side.`,use:`Let the image be enough. Do not solve the paradox. Notice whether awareness moves from being trapped in the loop to seeing the loop within a wider field.`,connect:`In the Grant-inspired language, this is the curvature-switch: not changing the geometry, but changing the angle from which the geometry is perceived.`},breath:{kicker:`Breath mode`,title:`Breath as optional rhythm`,summary:`Breath mode turns the same paradox practice into a timed visual rhythm.`,what:`Inhale follows blue, pause brightens gold, exhale follows copper, and rest lets the whole field settle.`,you:`For the person practicing, the breath is not the main achievement. It is just one way to pace attention while holding both states.`,use:`Use Breath mode only if timing helps. If it distracts you, stay with Natural mode and breathe normally.`,connect:`This keeps the same geometry: opening, returning, and resting at the meeting point without trying to force a result.`},closing:{kicker:`Reflection`,title:`What changed?`,summary:`This is a small integration note, not a performance score.`,what:`The closing prompt asks for one simple observation after holding the two poles.`,you:`For the person practicing, the useful data is often subtle: less charge, more space, a new sentence, or even honest resistance.`,use:`Write one sentence if there is one. If nothing changed, write that. The journal is private and local in this browser.`,connect:`The note records how the field felt after toroidal self-reference and hyperboloidal possibility were held together.`},"about-practice":{kicker:`About tab`,title:`Practice explanation`,summary:`This tab gives the honest foundation of the app.`,what:`It explains that Tone Paradox is independently created and inspired by Robert Edward Grant's geometric and consciousness-related language.`,you:`For the person using it, this tab answers why the app uses these unusual shapes instead of ordinary mood icons.`,use:`Read it when the symbols feel mysterious. Then return to practice and let the visuals become experiential rather than merely conceptual.`,connect:`It connects the copper toroid, blue hyperboloid, and gold focal ring to the act of holding {{poleOne}} and {{poleTwo}} together.`},"about-study":{kicker:`Study tab`,title:`Geometry as practice language`,summary:`This tab translates the symbols into a small vocabulary.`,what:`It names the copper toroid, blue hyperboloid, gold focal ring, and lens view as parts of one symbolic grammar.`,you:`For the person practicing, the study layer helps you understand why the app uses these forms instead of ordinary mood icons.`,use:`Use the Study tab when you want precision. Use the practice screen when you want direct experience.`,connect:`The cards map to conscious self-reference, unconscious possibility, the contact membrane, and the change in viewing angle.`},"about-advanced":{kicker:`Math Notes`,title:`The advanced math room`,summary:`This tab keeps the heavier mathematical language optional.`,what:`It gathers the Lens, cover/quotient, mirror membrane, cognitive Fourier, and zero-action breath ideas into short study notes.`,you:`For the person practicing, this is a way to study the symbolic architecture without needing it before you can practice.`,use:`Read one card at a time. If a term makes the practice less direct, leave it in Advanced and return to the moving field.`,connect:`This layer is inspired by formal geometry, but Tone Paradox uses it as contemplative language rather than proof you must accept.`},"about-breath":{kicker:`Breath tab`,title:`Timed attention`,summary:`This tab explains the optional breath rhythm.`,what:`Breath mode assigns inhale, pause, exhale, and rest to blue, gold, copper, and whole-field settling.`,you:`For the person practicing, this can help if your attention likes rhythm. It can be skipped if timing becomes distracting.`,use:`Let the rhythm support attention. Do not turn it into a task you have to perform perfectly.`,connect:`Natural mode is closer to a zero-action breath: opening and return are allowed without correction, and the field settles by itself.`},"about-library":{kicker:`Library tab`,title:`Suggested paradox doors`,summary:`The library is a set of entry points, not a diagnosis.`,what:`Each pair gives a common formed state and a possible opposite field.`,you:`For the person using it, a library pair is only useful if it feels alive enough to practice with.`,use:`Choose a pair, then edit the words so they fit your actual moment. The exact language matters.`,connect:`Each pair becomes copper plus blue: the known state and the not-yet-fully-formed possibility.`},"about-journal":{kicker:`Journal tab`,title:`Local insight memory`,summary:`The journal remembers what you practiced and what you noticed.`,what:`It stores the pair and a short note in this browser.`,you:`For the person practicing, this turns private experience into a pattern map over time.`,use:`Use Repeat pair when the same paradox returns. Look for recurring loops and recurring opposite fields.`,connect:`The journal shows which toroidal patterns keep appearing and which hyperboloidal possibilities you keep inviting.`},"about-plus":{kicker:`Plus tab`,title:`Future deeper layers`,summary:`This tab maps what could become premium without taking away the core practice.`,what:`It describes possible future layers: guided audio, deeper study, richer memory, personal decks, advanced geometry rooms, and iPhone sync.`,you:`For the person using it, Plus would mean more guidance, more continuity, and more ways to study your own paradox patterns.`,use:`Treat this as the roadmap. The current core remains: name two poles, watch both, notice what changes.`,connect:`The paid layer would deepen the same symbolic system rather than replace it with unrelated features.`},lens:{kicker:`Lens symbol`,title:`The eye of attention`,summary:`The shapes can be read as a symbolic inner eye.`,what:`In the Lens framing, the eye becomes a living image of ring, throat, aperture, and focal point. Tone Paradox uses that as a contemplative symbol.`,you:`For the person practicing, attention behaves like a lens. What you tighten around becomes sharp; what you soften around may reveal a wider pattern.`,use:`Use the image as an inner eye. Let it look at the whole paradox rather than staring only at the most charged word.`,connect:`The app's toroid, hyperboloid, and ring become a symbolic lens for perception: formed loop, open throat, and focal contact.`},angle:{kicker:`Curvature switch`,title:`Change the angle of seeing`,summary:`The practice is not only about two contents. It is about the vantage point that sees them.`,what:`A curvature-switch is the shift from being identified with the formed loop to observing the loop within a wider field.`,you:`For the person practicing, {{poleOne}} may first feel like me. Then it may become something moving in awareness beside {{poleTwo}}.`,use:`During Hold, ask silently: am I inside the loop, or can I see the loop inside a larger field?`,connect:`This keeps the Grant-inspired idea of observer-relative readings: the same structure can look different when the angle of perception changes.`},mirror:{kicker:`Mirror membrane`,title:`Where inner and outer meet`,summary:`The gold ring can be read as a membrane, not a verdict.`,what:`A mirror membrane reflects and translates. In the app, the focal ring is the place where the formed loop and open field can meet without either being flattened into the other.`,you:`For the person practicing, this means the moment may be showing you something without that something being the whole of you.`,use:`Let the ring be a boundary with contact. {{poleOne}} can be seen. {{poleTwo}} can be seen. Neither needs to swallow the other.`,connect:`This extends the focal-ring idea into mirror language: the ring is the contact surface where one side becomes visible to the other.`},cover:{kicker:`Cover / quotient`,title:`Open field and formed loop`,summary:`The advanced geometry gives a precise metaphor for why blue opens and copper returns.`,what:`The hyperboloid can be read as the unbounded cover. The torus can be read as the compact quotient: the bounded version that loops, repeats, and becomes personal.`,you:`For the person practicing, {{poleTwo}} is the wider possibility, while {{poleOne}} is the version of experience that has become familiar enough to repeat.`,use:`Use this when you want the math flavor. In direct practice, just remember: blue opens, copper returns.`,connect:`This is the advanced study version of the core app grammar: possibility becomes pattern, and pattern can be seen again from possibility.`},fourier:{kicker:`Cognitive Fourier`,title:`Sequence mind and pattern mind`,summary:`One way of knowing unfolds in time; another senses the whole tone at once.`,what:`The cognitive Fourier idea treats conscious thought like a time-domain sequence and unconscious knowing like a frequency-domain pattern.`,you:`For the person practicing, copper is the sentence as it unfolds. Blue is the recurring tone beneath the sentence.`,use:`When the story is loud, listen for the tone under it. When the field is vague, give it one honest word.`,connect:`This supports the same paradox practice: time-mind and pattern-mind are two readings of one inner signal.`},zeroaction:{kicker:`Zero-action breath`,title:`Begin with no correction`,summary:`Natural mode is the breath of opening and return without forcing the body to perform.`,what:`Zero-action is used here as a symbolic phrase for balance: no excess fixing, no collapse, no demand that one side win.`,you:`For the person practicing, this means the breath can be natural. You do not have to breathe correctly to observe {{pair}}.`,use:`Let breath happen first. Then let the image carry the paradox. Correction can come later, if it comes at all.`,connect:`This brings the recursion idea down to the body: opening and closing, field and loop, without losing the center.`},copper:{kicker:`Copper symbol`,title:`Toroid: the formed loop`,summary:`Copper represents the conscious, self-referential side.`,what:`The toroid is a closed returning form. In the app it carries the state that already has shape.`,you:`For the person practicing, this is the familiar pattern: the story, identity, memory, sensation, or loop that keeps recognizing itself.`,use:`Name it plainly. Watch it without making it wrong. It is the known side of the field.`,connect:`This follows the Grant-inspired mapping of toroidal form to recursive, multiplicative, conscious self-reference.`},blue:{kicker:`Blue symbol`,title:`Hyperboloid: the open field`,summary:`Blue represents the unconscious, imaginal, or possibility side.`,what:`The hyperboloid opens outward. In the app it carries what has not yet been fully named or formed.`,you:`For the person practicing, this is the opposite, shadow, or possible truth that can be invited without forcing belief.`,use:`Let it appear as possibility. Do not use it to deny the copper state.`,connect:`This follows the Grant-inspired mapping of hyperboloidal form to additive, expansive, open-ended perception.`},gold:{kicker:`Gold symbol`,title:`Focal ring: the mirror point`,summary:`Gold represents contact without collapse.`,what:`The ring marks the shared radius where the formed loop and open field can touch. It can also be read as the mirror membrane of the practice.`,you:`For the person practicing, this is the felt place where {{poleOne}} and {{poleTwo}} are both allowed to exist.`,use:`When the ring brightens, soften the need to choose. Let both readings be present.`,connect:`This follows the Grant-inspired focal-ring idea: the point where two different readings can be held together.`},terms:{kicker:`Terms layer`,title:`Words over the geometry`,summary:`The Terms toggle labels the moving structure so the symbols teach while you watch.`,what:`Plain mode uses practical language. Math mode uses more formal words from the geometry-inspired vocabulary.`,you:`For the person practicing, this can help you learn what the shapes mean without leaving the animation.`,use:`Turn it on when you want study. Turn it off when you want pure practice.`,connect:`The labels follow the copper, blue, and gold structures so each term stays tied to the part of the field it describes.`}},Zc=[`off`,`plain`,`math`],Qc=[{math:`self-referential`,plain:`self-referential mind`,kind:`amber`,offset:.08},{math:`multiplicative`,plain:`feeling-thinking loop`,kind:`amber`,offset:.6},{math:`quotient loop`,plain:`formed pattern`,kind:`amber`,offset:1.14},{math:`looping thought`,plain:`repeating story`,kind:`amber`,offset:2.25},{math:`identity`,plain:`the me pattern`,kind:`amber`,offset:3.36},{math:`the known`,plain:`what is here`,kind:`amber`,offset:4.52},{math:`cover field`,plain:`wider field`,kind:`blue`,offset:.02},{math:`unformed opposite`,plain:`the opposite`,kind:`blue`,offset:.42},{math:`imaginal field`,plain:`field of possibility`,kind:`blue`,offset:1.68},{math:`shadow possibility`,plain:`hidden possibility`,kind:`blue`,offset:2.8},{math:`frequency mind`,plain:`whole pattern`,kind:`blue`,offset:4.05},{math:`beyond category`,plain:`not yet named`,kind:`blue`,offset:5.24},{math:`r=1 contact`,plain:`where both touch`,kind:`gold`,offset:0},{math:`mirror membrane`,plain:`mirror point`,kind:`gold`,offset:Math.PI*.5},{math:`curvature switch`,plain:`shift view`,kind:`gold`,offset:Math.PI},{math:`without collapse`,plain:`neither disappears`,kind:`gold`,offset:Math.PI*1.5}],$c={height:2.96,steps:112,waistRadius:1.12,flareRadius:.58,depthScale:1,exponent:1.16},el=$c.waistRadius,tl=Math.PI/2,J={canvas:document.getElementById(`orbitScene`),landingPage:document.getElementById(`landingPage`),landingStartButton:document.getElementById(`landingStartButton`),landingTopStart:document.getElementById(`landingTopStart`),landingAboutButton:document.getElementById(`landingAboutButton`),landingAboutHeroButton:document.getElementById(`landingAboutHeroButton`),mantraPanel:document.getElementById(`mantraPanel`),meaningLayer:document.getElementById(`meaningLayer`),labelOne:document.getElementById(`labelOne`),labelTwo:document.getElementById(`labelTwo`),centerLabel:document.getElementById(`centerLabel`),phaseName:document.getElementById(`phaseName`),phaseCue:document.getElementById(`phaseCue`),practiceRail:document.getElementById(`practiceRail`),railItems:Array.from(document.querySelectorAll(`[data-rail-phase]`)),setupForm:document.getElementById(`setupForm`),setupSheet:document.getElementById(`setupSheet`),hereInput:document.getElementById(`hereInput`),alsoInput:document.getElementById(`alsoInput`),memorySummary:document.getElementById(`memorySummary`),breathPatternRow:document.getElementById(`breathPatternRow`),practiceDock:document.getElementById(`practiceDock`),phaseTimer:document.getElementById(`phaseTimer`),dockCue:document.getElementById(`dockCue`),pauseButton:document.getElementById(`pauseButton`),endButton:document.getElementById(`endButton`),closingSheet:document.getElementById(`closingSheet`),closingForm:document.getElementById(`closingForm`),insightInput:document.getElementById(`insightInput`),againButton:document.getElementById(`againButton`),aboutButton:document.getElementById(`aboutButton`),meaningToggleButton:document.getElementById(`meaningToggleButton`),contextButton:document.getElementById(`contextButton`),viewResetButton:document.getElementById(`viewResetButton`),viewPresetButtons:Array.from(document.querySelectorAll(`[data-view-preset]`)),aboutDialog:document.getElementById(`aboutDialog`),closeAbout:document.getElementById(`closeAbout`),contextDialog:document.getElementById(`contextDialog`),closeContext:document.getElementById(`closeContext`),contextKicker:document.getElementById(`contextKicker`),contextTitle:document.getElementById(`contextTitle`),contextSummary:document.getElementById(`contextSummary`),contextGrid:document.getElementById(`contextGrid`),brandReset:document.getElementById(`brandReset`),voiceRecorderPanel:document.getElementById(`voiceRecorderPanel`),voiceCueList:document.getElementById(`voiceCueList`),voiceStatus:document.getElementById(`voiceStatus`),voiceResetButton:document.getElementById(`voiceResetButton`),aboutTabs:Array.from(document.querySelectorAll(`.about-tab[data-about-tab]`)),aboutPanels:Array.from(document.querySelectorAll(`[data-about-panel]`)),journalList:document.getElementById(`journalList`),plusNote:document.getElementById(`plusNote`)},Y={tone:`unpleasant`,poleOne:`Anxiety`,poleTwo:`Safety`,practiceMode:`natural`,breathPattern:`box`,voiceGuide:`off`,meaningMode:`off`,durationMs:0,mode:`landing`,running:!1,startedAt:0,elapsedBeforePause:0,currentPhase:`idle`,activeAboutTab:`practice`,saved:iu()},nl={ready:!1,lastTime:0,amberFlow:.08,blueFlow:.58,amberSpeed:.7,blueSpeed:.7,blue:new H},rl={amber:.56,blue:.56,blueOrb:.56,hold:0,ringWave:0},X={pointers:new Map,yaw:0,pitch:0,zoom:1,targetYaw:0,targetPitch:0,targetZoom:1,pinchDistance:0,dragging:!1,preset:`front`},il={front:{yaw:0,pitch:0,zoom:1},above:{yaw:-.24,pitch:-.42,zoom:.96},focal:{yaw:.5,pitch:.16,zoom:1.12}},Z={recordings:au(),mediaRecorder:null,recordingKey:null,recordingStream:null,chunks:[],currentAudio:null,fadeFrame:0,lastCueKey:``,cueIndex:0,nextCueAt:0,voicesLoaded:!1},al=[],ol=new _n;ol.fog=new gn(132881,.08),ol.add(new ta(10473471,.34));var sl=new $i(16768904,1.45,7);sl.position.set(.7,.72,2.8),ol.add(sl);var cl=new $i(6416383,.82,7);cl.position.set(-1.05,.9,2.4),ol.add(cl);var ll=new Zi(42,1,.1,100);ll.position.set(0,.42,5.4),ll.lookAt(0,0,0);var ul=new Ic({canvas:J.canvas,antialias:!0,alpha:!0,powerPreference:`high-performance`});ul.setClearColor(0,0),ul.outputColorSpace=Le,ul.setPixelRatio(Math.min(window.devicePixelRatio||1,2));var dl=new cn;ol.add(dl);var fl=new cn,pl=new cn,ml=new cn;dl.add(pl,fl,ml);var Q={amberBand:hl(12610102,.13),amberCore:hl(14715714,.52),amberGlow:hl(8338466,.09),amberAura:hl(6236953,.035),amberFaint:gl(12938553,.16),amberDot:hl(15702861,.38),blueCore:gl(7795199,.92),blueFaint:gl(10155007,.36),blueRule:gl(9302783,.18),blueRim:gl(13958143,.96),blueGlow:gl(8188159,.14),blueRimGlow:gl(12122367,.18),blueSkin:new Sr({color:5889535,transparent:!0,opacity:.035,blending:2,depthWrite:!1,side:2}),focalMask:new Sr({color:132881,transparent:!0,opacity:.5,depthWrite:!1,depthTest:!1}),goldCore:hl(16775391,.96),goldGlow:hl(16773320,.2),focalSolid:new bi({color:16776172,emissive:16772540,emissiveIntensity:1.45,metalness:.08,roughness:.14,transparent:!0,opacity:.92,depthWrite:!1,depthTest:!1}),goldLine:gl(16770980,.34),ringRipple:hl(14252341,.12),contactBead:hl(16772511,.48),amberOrb:hl(15698749,.82),amberOrbGlow:hl(13195044,.16),blueOrb:hl(11072767,.96),blueOrbGlow:hl(5629695,.24)},$={torusBands:[],torusCores:[],torusGlows:[],torusAuras:[],torusGuide:null,torusGuideCore:null,torusGuideGlow:null,torusGuideCaps:[],torusGuideGlowCaps:[],amberLines:[],amberDots:[],blueLines:[],blueRuleLines:[],blueGlowLines:[],blueRims:[],blueGlowRims:[],blueSurfaces:[],axisDots:[],focalMask:null,focalRing:null,focalGlow:null,focalSpark:null,ringRipples:[],contactBeads:[],blueGuide:null,bluePossibilityGuides:[]};_l(),vl(),xl(),Sl(),Cl(),Lu(),window.addEventListener(`resize`,Lu),J.landingStartButton.addEventListener(`click`,ru),J.landingTopStart.addEventListener(`click`,ru),J.landingAboutButton.addEventListener(`click`,()=>Ul(`practice`)),J.landingAboutHeroButton.addEventListener(`click`,()=>Ul(`practice`)),J.setupForm.addEventListener(`submit`,$l),J.setupForm.addEventListener(`input`,Dl),J.pauseButton.addEventListener(`click`,eu),J.endButton.addEventListener(`click`,tu),J.closingForm.addEventListener(`submit`,nu),J.againButton.addEventListener(`click`,ru),J.aboutButton.addEventListener(`click`,()=>Ul(`practice`)),J.meaningToggleButton.addEventListener(`click`,zl),J.contextButton.addEventListener(`click`,()=>Gl(`auto`)),J.viewResetButton.addEventListener(`click`,Fl);for(let e of J.viewPresetButtons)e.addEventListener(`click`,()=>Il(e.dataset.viewPreset));J.closeAbout.addEventListener(`click`,()=>J.aboutDialog.close()),J.closeContext.addEventListener(`click`,()=>J.contextDialog.close()),J.aboutDialog.addEventListener(`click`,Yl),document.addEventListener(`click`,Wl),J.brandReset.addEventListener(`click`,e=>{e.preventDefault(),ru()}),J.voiceCueList.addEventListener(`click`,lu),J.voiceResetButton.addEventListener(`click`,gu);for(let e of J.aboutTabs)e.addEventListener(`click`,()=>vu(e.dataset.aboutTab));`speechSynthesis`in window&&window.speechSynthesis.addEventListener(`voiceschanged`,()=>{Z.voicesLoaded=!0}),J.canvas.addEventListener(`pointerdown`,Al),J.canvas.addEventListener(`pointermove`,jl),J.canvas.addEventListener(`pointerup`,Ml),J.canvas.addEventListener(`pointercancel`,Ml),J.canvas.addEventListener(`lostpointercapture`,Ml),J.canvas.addEventListener(`wheel`,Nl,{passive:!1}),su(),Dl(),bu(),document.body.dataset.mode=Y.mode,requestAnimationFrame(Ru);function hl(e,t){return new Sr({color:e,transparent:!0,opacity:t,blending:2,depthWrite:!1})}function gl(e,t){return new Kr({color:e,transparent:!0,opacity:t,blending:2,depthWrite:!1})}function _l(){let e=1.42,t=new li(e,.3,42,320),n=new li(e,.105,32,320),r=new li(e,.38,28,320),i=new Pr(new li(e,.52,24,320),Q.amberAura);i.rotation.x=Math.PI/2,fl.add(i),$.torusAuras.push(i);let a=new Pr(t,Q.amberBand);a.rotation.x=Math.PI/2,fl.add(a),$.torusBands.push(a);let o=new Pr(n,Q.amberCore);o.rotation.x=Math.PI/2,fl.add(o),$.torusCores.push(o);let s=new Pr(r,Q.amberGlow);s.rotation.x=Math.PI/2,fl.add(s),$.torusGlows.push(s);let c=Math.PI*.4,l=new cn;l.userData.arc=c,l.userData.radius=e;let u=new Pr(new li(e,.24,28,84,c),Q.amberOrbGlow.clone());u.rotation.x=Math.PI/2,u.material.opacity=0,l.add(u);let d=new Pr(new li(e,.11,26,84,c),Q.amberCore.clone());d.rotation.x=Math.PI/2,d.material.opacity=0,l.add(d);let f=new ci(.082,20,20),p=new ci(.15,20,20);for(let t of[0,c]){let n=new Pr(p,Q.amberOrbGlow.clone());n.position.set(Math.cos(t)*e,0,Math.sin(t)*e),n.material.opacity=0,l.add(n),$.torusGuideGlowCaps.push(n);let r=new Pr(f,Q.amberCore.clone());r.position.copy(n.position),r.material.opacity=0,l.add(r),$.torusGuideCaps.push(r)}fl.add(l),$.torusGuide=l,$.torusGuideGlow=u,$.torusGuideCore=d;for(let t=0;t<3;t+=1){let n=new Pr(new li(e,.028,14,260),Q.ringRipple.clone());n.rotation.x=Math.PI/2,n.userData.offset=t/3,n.material.opacity=0,fl.add(n),$.ringRipples.push(n)}for(let e=0;e<10;e+=1){let t=.94+e*.11,n=(e-4.5)*.042,r=Tl(t,t*(.42+Math.sin(e*.7)*.03),n,Q.amberFaint,240);r.rotation.y=e*.008,fl.add(r),$.amberLines.push(r)}for(let e=0;e<96;e+=1){let t=e/96*Math.PI*2,n=new Pr(new ci(.014,8,8),Q.amberDot);n.position.set(Math.cos(t)*1.52,0,Math.sin(t)*.74),n.userData.angle=t,fl.add(n),$.amberDots.push(n)}}function vl(){let{height:e,steps:t,waistRadius:n,depthScale:r}=$c,i=yl(e/2),a=Array.from({length:16},(e,t)=>t/16*Math.PI*2+Math.PI/32),o=new Pr(bl(72,128),Q.blueSkin.clone());o.userData.surface=!0,pl.add(o),$.blueSurfaces.push(o),a.forEach((n,i)=>{let a=[];for(let i=0;i<=t;i+=1){let o=(i/t-.5)*e,s=yl(o),c=Math.cos(n)*s,l=Math.sin(n)*s*r;a.push(new H(c,o,l))}let o=i%3==0,s=El(a,o?Q.blueCore:Q.blueFaint);if(o||(s.userData.faint=!0),pl.add(s),$.blueLines.push(s),o){let e=El(a,Q.blueGlow);e.scale.set(1.012,1,1.012),e.userData.glow=!0,pl.add(e),$.blueGlowLines.push(e)}});for(let n of[-1,1])for(let i=0;i<14;i+=1){let a=i/14*Math.PI*2+(n>0?Math.PI/14:0),o=[];for(let i=0;i<=t;i+=1){let s=i/t,c=(s-.5)*e,l=yl(c),u=a+n*(s-.5)*1.18;o.push(new H(Math.cos(u)*l,c,Math.sin(u)*l*r))}let s=El(o,Q.blueRule);s.userData.ruling=!0,s.userData.family=n,pl.add(s),$.blueRuleLines.push(s)}for(let t of[-e/2,e/2]){let e=Tl(i,i*r,t,Q.blueRim,240);e.userData.rim=!0,pl.add(e),$.blueRims.push(e);let n=Tl(i*1.025,i*r*1.045,t,Q.blueRimGlow,240);n.userData.glow=!0,pl.add(n),$.blueGlowRims.push(n)}let s=Tl(n,n*r,0,Q.blueRim,240);s.userData.waist=!0,pl.add(s),$.blueRims.push(s);let c=Tl(n*1.018,n*r*1.04,0,Q.blueRimGlow,240);c.userData.waist=!0,pl.add(c),$.blueGlowRims.push(c);for(let t=1;t<7;t+=1){let n=(t/7-.5)*e,i=yl(n),a=Tl(i,i*r,n,Q.blueGlow,220);a.material.opacity=.06,a.userData.contour=!0,pl.add(a),$.blueGlowLines.push(a)}}function yl(e){let t=Math.abs(e)/($c.height/2);return $c.waistRadius+t**+$c.exponent*$c.flareRadius}function bl(e,t){let{height:n,depthScale:r}=$c,i=[],a=[];for(let a=0;a<=e;a+=1){let o=(a/e-.5)*n,s=yl(o);for(let e=0;e<=t;e+=1){let n=e/t*Math.PI*2;i.push(Math.cos(n)*s,o,Math.sin(n)*s*r)}}let o=t+1;for(let n=0;n<e;n+=1)for(let e=0;e<t;e+=1){let t=n*o+e,r=t+1,i=t+o,s=i+1;a.push(t,i,r,r,i,s)}let s=new dr;return s.setAttribute(`position`,new $n(i,3)),s.setIndex(a),s.computeVertexNormals(),s}function xl(){$.focalMask=new Pr(new li(el,.096,22,240),Q.focalMask),$.focalMask.rotation.x=tl,$.focalMask.position.z=.012,$.focalMask.renderOrder=28,ml.add($.focalMask),$.focalGlow=new Pr(new li(el,.124,26,240),Q.goldGlow),$.focalGlow.rotation.copy($.focalMask.rotation),$.focalGlow.position.z=.034,$.focalGlow.material.depthTest=!1,$.focalGlow.renderOrder=29,ml.add($.focalGlow),$.focalRing=new Pr(new li(el,.04,34,240),Q.focalSolid),$.focalRing.rotation.copy($.focalMask.rotation),$.focalRing.position.z=.052,$.focalRing.renderOrder=30,ml.add($.focalRing),$.focalSpark=new Pr(new ci(.024,20,20),Q.goldCore.clone()),$.focalSpark.material.depthTest=!1,$.focalSpark.position.z=.112,$.focalSpark.renderOrder=31,ml.add($.focalSpark);let e=new ci(.012,10,10);for(let t=0;t<36;t+=1){let n=t/36*Math.PI*2,r=new Pr(e,Q.contactBead.clone());r.position.set(Math.cos(n)*el,0,Math.sin(n)*el),r.userData.angle=n,r.userData.seed=t*.618,r.renderOrder=31,ml.add(r),$.contactBeads.push(r)}let t=new ci(.015,10,10);for(let e=0;e<19;e+=1){let n=new Pr(t,Q.goldLine);n.position.y=-$c.height*.48+e*($c.height*.96/18),n.scale.setScalar(e===0||e===18?1.7:.75),ml.add(n),$.axisDots.push(n)}}function Sl(){$.blueGuide=wl(Q.blueOrb,Q.blueOrbGlow),$.blueGuide.userData.baseScale=.9,pl.add($.blueGuide),$.bluePossibilityGuides=Array.from({length:4},(e,t)=>{let n=wl(Q.blueOrb,Q.blueOrbGlow);return n.userData.baseScale=.48+t*.035,n.userData.flowOffset=.16+t*.21,n.userData.ribAngle=.82+t*1.13,n.userData.direction=t%2==0?1:-1,pl.add(n),n})}function Cl(){J.meaningLayer.replaceChildren(),al.length=0;for(let e of Qc){let t=document.createElement(`span`);t.className=`meaning-label meaning-${e.kind}`,t.textContent=e.plain,t.dataset.kind=e.kind,J.meaningLayer.append(t),al.push({...e,element:t})}}function wl(e,t){let n=new cn,r=new Pr(new ci(.095,22,22),t.clone()),i=new Pr(new ci(.028,18,18),e.clone()),a=[];n.add(r,i);for(let t=0;t<12;t+=1){let r=new Pr(new ci(.007,8,8),e.clone());r.material.opacity=0,r.userData.seed=t*1.618,n.add(r),a.push(r)}return n.userData.glow=r,n.userData.core=i,n.userData.sparkles=a,n}function Tl(e,t,n,r,i){let a=[];for(let r=0;r<=i;r+=1){let o=r/i*Math.PI*2;a.push(new H(Math.cos(o)*e,n,Math.sin(o)*t))}return El(a,r)}function El(e,t){return new ei(new dr().setFromPoints(e),t.clone())}function Dl(){let e=new FormData(J.setupForm);Y.tone=e.get(`tone`)||`unpleasant`,Y.practiceMode=e.get(`practiceMode`)===`breath`?`breath`:`natural`,Y.breathPattern=Uc[e.get(`breathPattern`)]?e.get(`breathPattern`):`box`,Y.voiceGuide=[`off`,`soft`,`mine`].includes(e.get(`voiceGuide`))?e.get(`voiceGuide`):`off`,Y.meaningMode=Zc.includes(e.get(`meaningLayer`))?e.get(`meaningLayer`):`off`;let t=e.get(`duration`)||`open`;Y.durationMs=t===`open`?0:Number(t)*6e4,Y.poleOne=Ol(J.hereInput.value,`What is here`),Y.poleTwo=Ol(J.alsoInput.value,`What is also true`),J.labelOne.textContent=Y.poleOne,J.labelTwo.textContent=Y.poleTwo,J.labelOne.title=Y.poleOne,J.labelTwo.title=Y.poleTwo,J.breathPatternRow.hidden=Y.practiceMode!==`breath`,J.voiceRecorderPanel.hidden=Y.voiceGuide!==`mine`,Y.voiceGuide!==`mine`&&Z.mediaRecorder&&fu(),Hl(),Vl(),bu()}function Ol(e,t){return e.trim().replace(/\s+/g,` `)||t}function kl(){return Y.mode!==`landing`}function Al(e){kl()&&(e.preventDefault(),J.canvas.setPointerCapture?.(e.pointerId),X.pointers.set(e.pointerId,{x:e.clientX,y:e.clientY}),X.dragging=!0,J.canvas.classList.add(`is-dragging`),X.pointers.size===2&&(X.pinchDistance=Pl()))}function jl(e){if(!kl()||!X.pointers.has(e.pointerId))return;e.preventDefault();let t=X.pointers.get(e.pointerId);if(X.pointers.set(e.pointerId,{x:e.clientX,y:e.clientY}),X.pointers.size>=2){let e=Pl();if(X.pinchDistance>0&&e>0){let t=e/X.pinchDistance;X.targetZoom=rd(X.targetZoom*t,.82,1.22),Ll()}X.pinchDistance=e;return}let n=e.clientX-t.x,r=e.clientY-t.y,i=Math.max(1,window.innerWidth),a=Math.max(1,window.innerHeight);X.targetYaw+=n/i*Math.PI*1.75,X.targetPitch=rd(X.targetPitch+r/a*Math.PI*.95,-.5,.56),Ll()}function Ml(e){X.pointers.delete(e.pointerId),X.pointers.size<2?X.pinchDistance=0:X.pinchDistance=Pl(),X.pointers.size===0&&(X.dragging=!1,J.canvas.classList.remove(`is-dragging`))}function Nl(e){if(!kl())return;e.preventDefault();let t=e.deltaY>0?-.035:.035;X.targetZoom=rd(X.targetZoom+t,.82,1.22),Ll()}function Pl(){let e=Array.from(X.pointers.values());if(e.length<2)return 0;let[t,n]=e;return Math.hypot(n.x-t.x,n.y-t.y)}function Fl(){Il(`front`)}function Il(e){let t=il[e]||il.front;X.targetYaw=t.yaw,X.targetPitch=t.pitch,X.targetZoom=t.zoom,X.preset=il[e]?e:`front`,Rl()}function Ll(){X.preset!==`custom`&&(X.preset=`custom`,Rl())}function Rl(){for(let e of J.viewPresetButtons){let t=e.dataset.viewPreset===X.preset;e.classList.toggle(`is-active`,t),e.setAttribute(`aria-pressed`,String(t))}}function zl(){Bl(Y.meaningMode===`off`?`plain`:Y.meaningMode===`plain`?`math`:`off`)}function Bl(e){Y.meaningMode=Zc.includes(e)?e:`off`;for(let e of document.querySelectorAll(`input[name="meaningLayer"]`))e.checked=e.value===Y.meaningMode;Hl(),Vl()}function Vl(){let e=Y.meaningMode!==`off`;J.meaningToggleButton.classList.toggle(`is-active`,e),J.meaningToggleButton.dataset.mode=Y.meaningMode,J.meaningToggleButton.setAttribute(`aria-pressed`,String(e)),J.meaningToggleButton.textContent=Y.meaningMode===`plain`?`Plain`:Y.meaningMode===`math`?`Math`:`Terms`,J.meaningLayer.classList.toggle(`is-visible`,e&&Y.mode!==`landing`)}function Hl(){let e=Y.meaningMode===`math`?`math`:`plain`;for(let t of al)t.element.textContent=t[e]}function Ul(e=`practice`){yu(),vu(e),J.aboutDialog.open||J.aboutDialog.showModal()}function Wl(e){let t=e.target.closest(`[data-context-topic]`);t&&(e.preventDefault(),Gl(t.dataset.contextTopic||`auto`))}function Gl(e=`auto`){if(Dl(),ql(Xc[Kl(e)]||Xc.practice),!J.contextDialog.open)try{J.contextDialog.showModal()}catch{J.contextDialog.show()}}function Kl(e){return e===`about-current`?`about-${Y.activeAboutTab||`practice`}`:e&&e!==`auto`?e:J.aboutDialog.open?`about-${Y.activeAboutTab||`practice`}`:Y.meaningMode!==`off`&&Y.mode===`practice`?`terms`:Y.mode===`landing`?`landing`:Y.mode===`setup`?`setup`:Y.mode===`closing`?`closing`:Y.mode===`practice`?Y.practiceMode===`breath`?`breath`:[`present`,`opposite`,`include`,`hold`].includes(Y.currentPhase)?Y.currentPhase:`practice`:`practice`}function ql(e){J.contextKicker.textContent=Jl(e.kicker),J.contextTitle.textContent=Jl(e.title),J.contextSummary.textContent=Jl(e.summary),J.contextGrid.replaceChildren();for(let[t,n]of Yc){let r=document.createElement(`article`);r.className=`context-card context-card-${t}`;let i=document.createElement(`h3`);i.textContent=n;let a=document.createElement(`p`);a.textContent=Jl(e[t]),r.append(i,a),J.contextGrid.append(r)}}function Jl(e){return String(e||``).replaceAll(`{{poleOne}}`,Y.poleOne).replaceAll(`{{poleTwo}}`,Y.poleTwo).replaceAll(`{{pair}}`,`${Y.poleOne} + ${Y.poleTwo}`)}function Yl(e){let t=e.target.closest(`[data-library-pair]`);if(t){Xl(t.dataset.libraryPair);return}let n=e.target.closest(`[data-repeat-entry]`);if(n){Zl(n.dataset.repeatEntry);return}let r=e.target.closest(`[data-about-jump]`);if(r){vu(r.dataset.aboutJump);return}let i=e.target.closest(`[data-plus-action]`);i&&Ql(i.dataset.plusAction)}function Xl(e){let[t,n]=String(e||``).split(`|`);!t||!n||(J.hereInput.value=t,J.alsoInput.value=n,document.querySelector(`input[name="tone"][value="unpleasant"]`).checked=!0,Dl(),J.aboutDialog.open&&J.aboutDialog.close(),ru())}function Zl(e){let t=Y.saved.find(t=>t.id===e);if(!t)return;J.hereInput.value=t.here||``,J.alsoInput.value=t.also||``;let n=document.querySelector(`input[name="tone"][value="${t.tone||`unpleasant`}"]`);n&&(n.checked=!0);let r=document.querySelector(`input[name="practiceMode"][value="${t.practice===`breath-field`?`breath`:`natural`}"]`);if(r&&(r.checked=!0),t.breathPattern){let e=document.querySelector(`input[name="breathPattern"][value="${t.breathPattern}"]`);e&&(e.checked=!0)}Dl(),J.aboutDialog.open&&J.aboutDialog.close(),ru()}function Ql(e){e===`meanings`?(Bl(`plain`),J.plusNote.textContent=`Plain terms are on. The orbiting words now translate the geometry into practice language.`):e===`audio`?J.plusNote.textContent=`Guided Library will hold longer voice sessions, Tone family voices, and thematic paradox sequences.`:e===`iphone`?J.plusNote.textContent=`iPhone Plus maps to Home Screen app mode, synced insight memory, and premium visual themes.`:e===`study`?(Bl(`math`),vu(`study`),J.plusNote.textContent=`Study notes keep the Grant-inspired grammar visible: toroid as self-referential multiplication, hyperboloid as additive/open extension, and the focal ring as the shared r=1 contact.`):e===`advanced`&&(Bl(`math`),vu(`advanced`),J.plusNote.textContent=`Math notes are open: Lens, mirror membrane, cover/quotient, cognitive Fourier, and zero-action breath.`)}function $l(e){e.preventDefault(),Dl(),Y.mode=`practice`,Y.running=!0,Y.startedAt=performance.now(),Y.elapsedBeforePause=0,Z.lastCueKey=``,Z.cueIndex=0,Z.nextCueAt=0,document.body.dataset.mode=Y.mode,J.setupSheet.hidden=!0,J.closingSheet.hidden=!0,J.practiceDock.hidden=!1,J.pauseButton.textContent=`Pause`,J.pauseButton.setAttribute(`aria-label`,`Pause practice`),Y.currentPhase=Y.practiceMode===`breath`?`inhale`:`present`,J.phaseName.textContent=Y.practiceMode===`breath`?`Inhale`:`Present`,Fu(Y.currentPhase),Y.practiceMode===`breath`?Cu():Su(0,!0)}function eu(){if(Y.mode!==`practice`)return;let e=performance.now();if(Y.running){Y.elapsedBeforePause+=e-Y.startedAt,Y.running=!1,ju(),J.pauseButton.textContent=`Resume`,J.pauseButton.setAttribute(`aria-label`,`Resume practice`),J.phaseName.textContent=`Paused`,Fu(`paused`);return}Y.running=!0,Y.startedAt=e,J.pauseButton.textContent=`Pause`,J.pauseButton.setAttribute(`aria-label`,`Pause practice`),J.phaseName.textContent=Y.practiceMode===`breath`?Nu(Y.currentPhase):Gu(Y.currentPhase),Fu(Y.currentPhase)}function tu(){Y.mode=`closing`,Y.running=!1,ju(),document.body.dataset.mode=Y.mode,J.practiceDock.hidden=!0,J.closingSheet.hidden=!1,J.phaseName.textContent=`Complete`,J.phaseCue.textContent=`Let the center remain.`,J.centerLabel.textContent=`+`}function nu(e){e.preventDefault();let t={id:crypto.randomUUID(),at:new Date().toISOString(),tone:Y.tone,here:Y.poleOne,also:Y.poleTwo,practice:Y.practiceMode===`breath`?`breath-field`:`paradox-field`,breathPattern:Y.practiceMode===`breath`?Y.breathPattern:null,durationMs:Y.durationMs,insight:J.insightInput.value.trim()};Y.saved.unshift(t),localStorage.setItem(Lc,JSON.stringify(Y.saved.slice(0,24))),yu(),bu(),ru()}function ru(){Y.mode=`setup`,Y.running=!1,ju(),Y.elapsedBeforePause=0,Y.currentPhase=`idle`,xd(),document.body.dataset.mode=Y.mode,J.setupSheet.hidden=!1,J.practiceDock.hidden=!0,J.closingSheet.hidden=!0,J.insightInput.value=``,J.phaseName.textContent=`Arrive`,J.phaseCue.textContent=`Name the two poles.`,J.centerLabel.textContent=`+`,Vl(),Iu(`idle`),bu()}function iu(){try{return JSON.parse(localStorage.getItem(Lc)||`[]`)}catch{return[]}}function au(){try{return JSON.parse(localStorage.getItem(Rc)||`{}`)}catch{return{}}}function ou(){try{return localStorage.setItem(Rc,JSON.stringify(Z.recordings)),!0}catch{return _u(`Voice storage is full.`),!1}}function su(){J.voiceCueList.replaceChildren();for(let e of qc){let t=document.createElement(`div`),n=!!Z.recordings[e],r=Z.recordingKey===e;t.className=`voice-cue-row${n?` has-clip`:``}${r?` is-recording`:``}`;let i=document.createElement(`div`);i.className=`voice-cue-copy`;let a=document.createElement(`strong`);a.textContent=Gc[e]||e;let o=document.createElement(`span`);o.textContent=Wc[e],i.append(a,o);let s=document.createElement(`div`);s.className=`voice-cue-actions`,s.append(cu(r?`Stop`:`Record`,`record`,e),cu(`Play`,`play`,e,!n&&!ku()),cu(`Clear`,`clear`,e,!n)),t.append(i,s),J.voiceCueList.append(t)}}function cu(e,t,n,r=!1){let i=document.createElement(`button`);return i.className=`mini-button${t===`record`?` record-button`:``}`,i.type=`button`,i.dataset.voiceAction=t,i.dataset.voiceKey=n,i.disabled=r,i.textContent=e,i}function lu(e){let t=e.target.closest(`[data-voice-action]`);if(!t)return;let n=t.dataset.voiceKey,r=t.dataset.voiceAction;Wc[n]&&(r===`record`?uu(n):r===`play`?wu(n,!0):r===`clear`&&hu(n))}async function uu(e){if(Z.mediaRecorder){Z.recordingKey===e?fu():_u(`Finish the current cue first.`);return}if(!navigator.mediaDevices?.getUserMedia||!window.MediaRecorder){_u(`Recording is not available here.`);return}try{let t=await navigator.mediaDevices.getUserMedia({audio:!0}),n=du(),r=n?new MediaRecorder(t,n):new MediaRecorder(t);Z.mediaRecorder=r,Z.recordingKey=e,Z.recordingStream=t,Z.chunks=[],r.addEventListener(`dataavailable`,e=>{e.data?.size&&Z.chunks.push(e.data)}),r.addEventListener(`stop`,pu),r.addEventListener(`error`,()=>{mu(),_u(`Recording stopped.`),su()}),r.start(),_u(`Recording ${e}.`),su()}catch{mu(),_u(`Microphone permission was not granted.`)}}function du(){let e=[`audio/webm;codecs=opus`,`audio/webm`,`audio/mp4`,`audio/aac`].find(e=>MediaRecorder.isTypeSupported?.(e));return e?{mimeType:e}:null}function fu(){Z.mediaRecorder&&Z.mediaRecorder.state===`recording`&&Z.mediaRecorder.stop()}function pu(){let e=Z.recordingKey,t=Z.mediaRecorder?.mimeType||Z.chunks[0]?.type||`audio/webm`,n=new Blob(Z.chunks,{type:t});if(mu(),!e||!n.size){_u(`Nothing was recorded.`),su();return}let r=new FileReader;r.addEventListener(`loadend`,()=>{Z.recordings[e]={dataUrl:r.result,type:n.type,at:new Date().toISOString()},ou()&&_u(`${Nu(e)} cue saved.`),su()}),r.readAsDataURL(n)}function mu(){Z.recordingStream?.getTracks().forEach(e=>e.stop()),Z.mediaRecorder=null,Z.recordingKey=null,Z.recordingStream=null,Z.chunks=[]}function hu(e){delete Z.recordings[e],ou(),_u(`${Nu(e)} cue cleared.`),su()}function gu(){Z.mediaRecorder&&fu(),Z.recordings={},ou(),_u(`Voice guide cleared.`),su()}function _u(e){J.voiceStatus.textContent=e}function vu(e){let t=[`practice`,`study`,`advanced`,`breath`,`library`,`journal`,`plus`].includes(e)?e:`practice`;Y.activeAboutTab=t,t===`journal`&&yu();for(let e of J.aboutTabs)e.classList.toggle(`is-active`,e.dataset.aboutTab===t);for(let e of J.aboutPanels){let n=e.dataset.aboutPanel===t;e.hidden=!n,e.classList.toggle(`is-active`,n)}}function yu(){if(J.journalList){if(J.journalList.replaceChildren(),!Y.saved.length){let e=document.createElement(`div`);e.className=`journal-empty`,e.textContent=`No saved insights yet. Complete a practice and save one simple sentence.`,J.journalList.append(e);return}for(let e of Y.saved.slice(0,12)){let t=document.createElement(`article`);t.className=`journal-item`;let n=document.createElement(`div`);n.className=`journal-item-head`;let r=document.createElement(`strong`);r.textContent=`${e.here} + ${e.also}`;let i=document.createElement(`span`);i.textContent=xu(e.at);let a=document.createElement(`p`);a.textContent=e.insight||`No note saved.`;let o=document.createElement(`div`);o.className=`journal-item-actions`;let s=document.createElement(`button`);s.className=`journal-repeat-button`,s.type=`button`,s.dataset.repeatEntry=e.id,s.textContent=`Repeat pair`,o.append(s),n.append(r,i),t.append(n,a,o),J.journalList.append(t)}}}function bu(){if(!J.memorySummary)return;let e=Y.saved.length;if(!e){J.memorySummary.textContent=`No saved insights yet. This practice can stay private and local.`;return}let t=Y.saved[0],n=e===1?`1 saved insight`:`${e} saved insights`;J.memorySummary.textContent=`${n} locally. Last pair: ${t.here} + ${t.also}.`}function xu(e){try{return new Intl.DateTimeFormat(void 0,{month:`short`,day:`numeric`,hour:`numeric`,minute:`2-digit`}).format(new Date(e))}catch{return``}}function Su(e,t=!1){if(Y.mode!==`practice`||!Y.running||Y.voiceGuide===`off`||Y.practiceMode===`breath`||!t&&e<Z.nextCueAt)return;let n=Kc[Z.cueIndex%Kc.length];Z.cueIndex+=1,Z.nextCueAt=e+(Z.cueIndex===1?Vc:Bc),Z.lastCueKey=n,wu(n,!1)}function Cu(){Y.mode!==`practice`||!Y.running||Y.voiceGuide===`off`||(Z.lastCueKey=`breath`,wu(`breath`,!1))}function wu(e,t){let n=Z.recordings[e];if(Y.voiceGuide===`mine`&&n?.dataUrl){Tu(n.dataUrl,e);return}if(Y.voiceGuide===`mine`&&t&&!n?.dataUrl&&_u(`${Nu(e)} has no custom recording yet.`),(Y.voiceGuide===`soft`||Y.voiceGuide===`mine`)&&Jc[e]){Eu(e);return}Ou(e)}function Tu(e,t){Du(e,t)}function Eu(e){Du(new URL(Jc[e],window.location.href).href,e,()=>Ou(e))}function Du(e,t,n){ju(!0);let r=new Audio(e);r.volume=0,Z.currentAudio=r,r.addEventListener(`ended`,()=>{Z.currentAudio===r&&(Z.currentAudio=null)}),r.play().then(()=>{Mu(r,.84,260)}).catch(()=>{Z.currentAudio===r&&(Z.currentAudio=null),n?.()})}function Ou(e){if(!ku())return;ju(!0);let t=new SpeechSynthesisUtterance(Wc[e]);t.voice=Au(),t.rate=.78,t.pitch=.92,t.volume=.72,window.speechSynthesis.speak(t)}function ku(){return`speechSynthesis`in window&&`SpeechSynthesisUtterance`in window}function Au(){let e=window.speechSynthesis.getVoices();return e.find(e=>/Samantha|Karen|Moira|Tessa|Serena|Victoria/i.test(e.name))||e.find(e=>e.lang?.toLowerCase().startsWith(`en`))||e[0]||null}function ju(e=!1){if(`speechSynthesis`in window&&window.speechSynthesis.cancel(),!Z.currentAudio)return;let t=Z.currentAudio;if(Z.currentAudio=null,e){Z.fadeFrame&&cancelAnimationFrame(Z.fadeFrame),Z.fadeFrame=0,t.pause(),t.currentTime=0;return}Mu(t,0,180,()=>{t.pause(),t.currentTime=0})}function Mu(e,t,n,r){Z.fadeFrame&&cancelAnimationFrame(Z.fadeFrame);let i=e.volume,a=performance.now(),o=s=>{let c=Math.min(1,(s-a)/n);e.volume=i+(t-i)*Sd(c),c<1?Z.fadeFrame=requestAnimationFrame(o):(Z.fadeFrame=0,r?.())};Z.fadeFrame=requestAnimationFrame(o)}function Nu(e){return e&&e.charAt(0).toUpperCase()+e.slice(1)}function Pu(e){return Y.mode===`practice`&&Y.running?Y.elapsedBeforePause+e-Y.startedAt:Y.elapsedBeforePause}function Fu(e){let t={present:`Stay with what is here.`,opposite:`Let the opposite appear.`,include:`Let both be here.`,hold:`Notice the angle of seeing.`,paused:`Let the field remain.`,closing:`Let the center remain.`,setup:`Name the two poles.`},n={present:`Watch the copper loop.`,opposite:`Let the blue opposite appear.`,include:`Keep both in view.`,hold:`See the loop within the field.`,paused:`Resume when ready.`,closing:`Let the center remain.`,setup:`Name the two poles.`},r={inhale:`Follow the blue orb.`,pause:`Let the center ring shine.`,exhale:`Follow the copper loop.`,rest:`Let the field settle.`,paused:`Resume when ready.`},i=Y.practiceMode===`breath`?r[e]||r.inhale:t[e]||t.setup;J.phaseCue.textContent=i,J.dockCue.textContent=Y.practiceMode===`breath`?e===`paused`?`Resume when ready.`:i:n[e]||i,J.centerLabel.textContent=`+`,Iu(e)}function Iu(e){if(!J.railItems?.length)return;let t=Y.practiceMode===`breath`?{inhale:`opposite`,pause:`hold`,exhale:`present`,rest:`include`,paused:`hold`}[e]||`present`:{present:`present`,opposite:`opposite`,include:`include`,hold:`hold`,paused:`hold`}[e]||`present`;for(let e of J.railItems){let n=e.dataset.railPhase===t&&Y.mode===`practice`;e.classList.toggle(`is-active`,n),e.setAttribute(`aria-current`,n?`step`:`false`)}}function Lu(){let e=window.innerWidth,t=window.innerHeight;ul.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),ul.setSize(e,t,!1),ll.aspect=e/t,ll.fov=e<520?46:40,ll.updateProjectionMatrix()}function Ru(e){let t=Pu(e),n=Y.practiceMode===`breath`?Hu(t):null,r=Y.practiceMode===`natural`?Uu(t):null;Y.mode===`practice`&&Y.durationMs>0&&t>=Y.durationMs&&tu(),Y.mode===`practice`&&Y.practiceMode===`breath`&&n?.phase.key!==Y.currentPhase?(Y.currentPhase=n.phase.key,J.phaseName.textContent=n.phase.name,Fu(n.phase.key)):Y.mode===`practice`&&Y.practiceMode===`natural`&&r?.phase.key!==Y.currentPhase&&(Y.currentPhase=r.phase.key,J.phaseName.textContent=r.phase.name,Fu(r.phase.key)),Su(t),zu(e,t,n,r),ad(),hd(e,n,r),od(e),ul.render(ol,ll),requestAnimationFrame(Ru)}function zu(e,t,n,r){let i=e*.001,a=Y.mode===`practice`&&Y.practiceMode===`breath`&&n,o=Y.mode===`practice`&&Y.practiceMode===`natural`&&r,s=a?Ku(n.phase.key,n.phaseProgress):Math.sin(i*.42)*.5+.5,c=+(Y.mode===`practice`),l=a?qu(n.phase.key,n.phaseProgress):o?Yu(r):c*(.76+Math.sin(i*.46)*.08),u=a?Ju(n.phase.key):o?Xu(r.phase.key):Y.mode===`practice`?`both`:`idle`,d=o?Zu(r):td(`one`,u,l),f=o?Qu(r,i):td(`two`,u,l),p=o?$u(r,i):f,m=window.innerWidth<520,h=Bu(m),g=Vu(m);rl.amber=nd(rl.amber,d,.045),rl.blue=nd(rl.blue,f,.045),rl.blueOrb=nd(rl.blueOrb,p,.08),rl.hold=nd(rl.hold,l,.05),rl.ringWave=(rl.ringWave+(.003+rl.hold*.011))%1,X.yaw=nd(X.yaw,X.targetYaw,.1),X.pitch=nd(X.pitch,X.targetPitch,.1),X.zoom=nd(X.zoom,X.targetZoom,.08);let _=rl.amber,v=rl.blue,y=rl.hold;dl.position.y+=(h-dl.position.y)*.06;let b=g*X.zoom;dl.scale.setScalar(dl.scale.x+(b-dl.scale.x)*.06);let x=zc?0:Math.sin(i*.22)*.05,S=zc?0:Math.sin(i*.18)*.018;dl.rotation.y=x+X.yaw,dl.rotation.x=.02+S+X.pitch,fl.rotation.x=0,fl.rotation.y=zc?0:i*.075,fl.scale.setScalar(1+_*.045+y*.02),pl.scale.set(1+v*.02,1+v*.07+s*.025,1);let C=1+Math.sin(i*2.6)*(y*.01+.004);ml.scale.setScalar(C),ml.rotation.y=zc?0:Math.sin(i*.34)*.08,ed(Q.amberBand,.038+_*.052+y*.026),ed(Q.amberCore,.18+_*.16+y*.044),ed(Q.amberGlow,.018+_*.052+y*.032),ed(Q.amberAura,.004+_*.014+y*.024),ed(Q.blueCore,.54+v*.36+y*.1),ed(Q.blueRim,.62+v*.3+y*.08),ed(Q.blueSkin,.016+v*.04+y*.032),ed(Q.focalSolid,.88+y*.12),ed(Q.focalMask,.18+y*.2),ed(Q.goldCore,.68+y*.3),ed(Q.goldGlow,.16+y*.34),$.focalSpark&&($.focalSpark.material.opacity=.38+y*.4,$.focalSpark.scale.setScalar(.82+y*.5+Math.sin(i*3.2)*(.018+y*.04)));for(let e of $.contactBeads){let t=Math.max(0,Math.sin(i*2.1+e.userData.seed*7));e.material.opacity=.14+y*.32+t*(.08+y*.18),e.scale.setScalar(.68+y*.38+t*.42)}for(let e of $.ringRipples){let t=(rl.ringWave+e.userData.offset)%1,n=Math.sin(t*Math.PI);e.scale.setScalar(1+y*(.05+t*.18)),e.material.opacity=y*n*.11}for(let e of $.amberLines)e.material.opacity=.035+_*.07+y*.032;for(let e of $.amberDots)e.position.y=Math.sin(i*.62+e.userData.angle*3)*(.01+y*.008),e.material.opacity=.08+_*.15+y*.075;for(let e of $.blueLines){let t=e.userData.faint?.34:.56;e.material.opacity=Math.min(1,t+v*.3+y*.12)}for(let e of $.blueRuleLines){let t=e.userData.family>0?Math.sin(i*.38)*.5+.5:Math.cos(i*.38)*.5+.5;e.material.opacity=.055+v*.105+y*.06+t*.018}for(let e of $.blueGlowLines){let t=e.userData.contour?.06:e.userData.rear?.07:.11,n=e.userData.contour||e.userData.rear?.09:.17;e.material.opacity=t+v*n+y*.08}for(let e of $.blueRims){let t=e.userData.waist?.12:0;e.material.opacity=Math.min(1,.62+t+v*.28+y*.1)}for(let e of $.blueGlowRims){let t=e.userData.waist?.06:0;e.material.opacity=.14+t+v*.16+y*.1}for(let e of $.blueSurfaces)e.material.opacity=.012+v*.044+y*.034;for(let e of $.axisDots)e.material.opacity=.14+y*.44;let w=m?6.62:5.88,T=s*.055;if(ll.position.z=w-T-y*.1,ll.position.y=m?.32:.4,ll.lookAt(0,0,0),Y.mode===`practice`){let e=Y.practiceMode===`breath`&&n?Math.max(0,n.phase.duration-n.phaseElapsed):Y.durationMs>0?Math.max(0,Y.durationMs-t):t;J.phaseTimer.textContent=Cd(e)}}function Bu(e){return Y.mode===`landing`?e?.34:.2:Y.mode===`setup`?e?.72:.48:Y.mode===`practice`?e?.16:.08:Y.mode===`closing`?e?.3:.18:e?.18:.1}function Vu(e){return Y.mode===`landing`?e?.72:.82:Y.mode===`setup`?e?.7:.86:Y.mode===`practice`?e?.66:.68:Y.mode===`closing`?e?.62:.78:e?.78:.88}function Hu(e){let t=(Uc[Y.breathPattern]||Uc.box).phases,n=t.reduce((e,t)=>e+t.duration,0),r=(e%n+n)%n,i=0;for(let e of t){if(r<=i+e.duration){let t=Math.max(0,r-i);return{phase:e,phaseElapsed:t,phaseProgress:Math.max(0,Math.min(1,t/e.duration)),cycleProgress:r/n}}i+=e.duration}return{phase:t[0],phaseElapsed:0,phaseProgress:0,cycleProgress:0}}function Uu(e){let t=Hc.reduce((e,t)=>e+t.duration,0),n=(e%t+t)%t,r=0;for(let e of Hc){if(n<=r+e.duration){let i=Math.max(0,n-r);return{phase:e,phaseElapsed:i,phaseProgress:Math.max(0,Math.min(1,i/e.duration)),cycleProgress:n/t}}r+=e.duration}return{phase:Hc[0],phaseElapsed:0,phaseProgress:0,cycleProgress:0}}function Wu(e){return Hc.find(t=>t.key===e)||Hc[0]}function Gu(e){return Wu(e).name}function Ku(e,t){let n=Sd(t);return e===`inhale`?n:e===`pause`?1:e===`exhale`?1-n:e===`rest`?0:.5}function qu(e,t){if(Y.mode!==`practice`)return 0;if(e===`pause`){let e=Sd(Math.min(t/.28,1)),n=1-Sd(Math.max(0,(t-.82)/.18));return Math.max(.18,Math.min(e,n))*.98}return e===`rest`?.32:.18}function Ju(e){return Y.mode===`practice`?e===`inhale`?`two`:e===`exhale`?`one`:`both`:`idle`}function Yu(e){if(Y.mode!==`practice`)return 0;let t=e.phase.key,n=e.phaseProgress;if(t===`hold`){let e=Sd(Math.min(n/.22,1)),t=1-Sd(Math.max(0,(n-.78)/.22));return Math.max(.62,Math.min(e,t))*.98}return t===`include`?.38+Sd(n)*.12:t===`opposite`?.18+Sd(n)*.08:.12}function Xu(e){return Y.mode===`practice`?e===`present`?`one`:`both`:`idle`}function Zu(e){return Y.mode===`practice`?e.phase.key===`hold`?1:.92+Sd(1-e.phaseProgress)*.05:.56}function Qu(e,t){let n=Sd(e.phaseProgress),r=Math.sin(t*1.8)*.5+.5;return e.phase.key===`present`?.36+r*.035:e.phase.key===`opposite`?.38+n*.16+r*.05:e.phase.key===`include`?.58+n*.16+r*.06:e.phase.key===`hold`?.86+r*.1:.56}function $u(e,t){let n=Sd(e.phaseProgress),r=Math.sin(t*2.2)*.5+.5,i=.5+Math.sin(t*4.1)*.5;return e.phase.key===`present`?.13+r*.05:e.phase.key===`opposite`?.16+n*(.22+i*.52):e.phase.key===`include`?.54+n*.18+r*.16:e.phase.key===`hold`?1:.42}function ed(e,t){e.opacity=Math.max(0,Math.min(1,t))}function td(e,t,n){return Y.mode===`practice`?t===`both`?.72+n*.26:t===e?.94:.42:.56}function nd(e,t,n){return e+(t-e)*n}function rd(e,t,n){return Math.max(t,Math.min(n,e))}function id(e,t,n){let r=rd((n-e)/(t-e),0,1);return r*r*(3-2*r)}function ad(){if(Y.mode===`practice`&&Y.practiceMode===`natural`){let e=Y.currentPhase||`present`,t=rl.blueOrb>.34||e===`include`||e===`hold`;J.mantraPanel.dataset.phase=e,J.mantraPanel.dataset.active=t?`both`:`one`,J.labelOne.classList.add(`is-active`),J.labelTwo.classList.toggle(`is-active`,t),J.centerLabel.classList.toggle(`is-holding`,e===`hold`||rl.hold>.58),J.labelOne.style.opacity=`${.74+Math.min(1,rl.amber)*.26}`,J.labelTwo.style.opacity=`${.16+Math.min(1,rl.blueOrb)*.84}`,J.labelOne.style.setProperty(`--label-glow-alpha`,(.12+rl.amber*.18).toFixed(3)),J.labelTwo.style.setProperty(`--label-glow-alpha`,(.08+rl.blueOrb*.22).toFixed(3));return}let e=Y.mode===`practice`&&Y.practiceMode===`breath`?Y.currentPhase:Y.mode===`practice`?`hold`:`idle`,t=Y.mode===`practice`&&Y.practiceMode===`breath`?Ju(Y.currentPhase):Y.mode===`practice`?`both`:`idle`;J.mantraPanel.dataset.phase=e,J.mantraPanel.dataset.active=t,J.labelOne.style.opacity=``,J.labelTwo.style.opacity=``,J.labelOne.style.removeProperty(`--label-glow-alpha`),J.labelTwo.style.removeProperty(`--label-glow-alpha`),J.labelOne.classList.toggle(`is-active`,t===`one`||t===`both`),J.labelTwo.classList.toggle(`is-active`,t===`two`||t===`both`),J.centerLabel.classList.toggle(`is-holding`,t===`both`)}function od(e){let t=Y.meaningMode!==`off`&&Y.mode!==`landing`;if(J.meaningLayer.classList.toggle(`is-visible`,t),!t){for(let e of al)e.element.style.opacity=`0`;return}let n=e*.001,r=window.innerWidth,i=window.innerHeight;dl.updateMatrixWorld(!0),ll.updateMatrixWorld(!0);let a=[],o=al.filter(e=>e.kind===`gold`),s=n/(window.innerWidth<520?17.5:14.2),c=o.length>0?Math.floor(s)%o.length:0,l=cd(s-Math.floor(s)),u=ld();for(let e of al){let{x:t,y:s,z:d}=pd(e,n,r,i),f=r<520?92:70,p=d>-1&&d<1&&t>f&&t<r-f&&s>96&&s<i-138,m=cd((n/(r<520?23:18.5)+e.offset*.17)%1),h=Y.mode===`practice`?1:.62,g=e.kind===`gold`?1:rd(1-Math.max(0,d)*.24,.28,1),_=dd(e,n),v=e.kind===`gold`?1:fd(t,s,r,i),y=ud(e.kind,u),b=(e.kind===`gold`?o.indexOf(e):-1)===c,x=e.kind===`gold`?p&&b?(.06+l*.3)*h*y*(.72+rl.hold*.42):0:p?(.08+m*.3)*h*g*_*v*y:0,S=Math.min(190,Math.max(70,e.element.textContent.length*(r<520?7.1:7.7)+22)),C=r<520?24:26,w={left:t-S/2-6,right:t+S/2+6,top:s-C/2-5,bottom:s+C/2+5};e.kind!==`gold`&&x>.12&&a.some(e=>sd(w,e))&&(x=0),x>.12&&a.push(w),e.element.style.transform=`translate3d(${t}px, ${s}px, 0) translate(-50%, -50%)`,e.element.style.opacity=x.toFixed(3)}}function sd(e,t){return e.left<t.right&&e.right>t.left&&e.top<t.bottom&&e.bottom>t.top}function cd(e){let t=(e%1+1)%1;return t<.12?id(0,.12,t):t<.82?1:t<.98?1-id(.82,.98,t):0}function ld(){if(Y.mode!==`practice`)return`all`;if(Y.practiceMode===`breath`){if(Y.currentPhase===`inhale`)return`blue`;if(Y.currentPhase===`exhale`)return`amber`;if(Y.currentPhase===`pause`||Y.currentPhase===`rest`)return`gold`}if(Y.practiceMode===`natural`){if(Y.currentPhase===`present`)return`amber`;if(Y.currentPhase===`opposite`)return`blue`;if(Y.currentPhase===`hold`)return`gold`}return`all`}function ud(e,t){return t===`all`?1:e===t?1.18:t===`gold`&&e!==`gold`?.28:e===`gold`?.34:.32}function dd(e,t){if(e.kind===`amber`){let n=t*.12+e.offset;return .52+id(.22,.72,Math.abs(Math.cos(n)))*.48}if(e.kind===`blue`){let n=Math.sin(t*.14+e.offset),r=t*.07+e.offset,i=id(.22,.68,Math.abs(Math.cos(r))),a=id(.08,.28,Math.abs(n))*.38;return .5+Math.max(i,a)*.5}return 1}function fd(e,t,n,r){let i=n*.5,a=r*.48,o=(e-i)/(n*.17),s=(t-a)/(r*.11);return id(.92,1.28,Math.sqrt(o*o+s*s))}function pd(e,t,n,r){let i=md(e,t).clone().project(ll),a=(i.x*.5+.5)*n,o=(-i.y*.5+.5)*r;if(e.kind===`gold`){let t=ml.localToWorld(new H(0,0,0)).project(ll),i=(t.x*.5+.5)*n,s=(-t.y*.5+.5)*r,c=n<520?n*.23:132,l=n<520?40:50;return a=i+Math.cos(e.offset)*c,o=s+Math.sin(e.offset)*l,{x:a,y:o,z:t.z}}return{x:a,y:o,z:i.z}}function md(e,t){if(e.kind===`amber`){let n=t*.12+e.offset,r=1.76,i=new H(Math.cos(n)*r,Math.sin(t*.48+e.offset)*.06,Math.sin(n)*r);return fl.localToWorld(i)}if(e.kind===`blue`){let n=Math.sin(t*.14+e.offset)*($c.height*.43),r=yl(n)*1.06,i=t*.07+e.offset,a=new H(Math.cos(i)*r,n,Math.sin(i)*r*$c.depthScale);return pl.localToWorld(a)}let n=t*.1+e.offset,r=new H(el*1.08*Math.cos(n),Math.sin(t*.52+e.offset)*.025,el*1.08*Math.sin(n));return ml.localToWorld(r)}function hd(e,t,n){let r=e*.001,i=Y.mode===`practice`&&Y.practiceMode===`breath`&&t?t.phase.key:Y.mode===`practice`&&Y.practiceMode===`natural`&&n?n.phase.key:Y.mode===`practice`?`hold`:`idle`,a=Math.max(.001,(e-nl.lastTime)/1e3||.016),o=Math.min(.05,a),s=gd(i),c=nl.ready?1-Math.exp(-a*6):1;nl.amberSpeed=nd(nl.amberSpeed,s.amber,.055),nl.blueSpeed=nd(nl.blueSpeed,s.blue,.055),nl.amberFlow=(nl.amberFlow+o*.085*nl.amberSpeed)%1,nl.blueFlow=(nl.blueFlow+o*.071*nl.blueSpeed)%1;let l=vd(nl.blueFlow,r);nl.ready?nl.blue.lerp(l,c):(nl.blue.copy(l),nl.ready=!0),nl.lastTime=e,$.blueGuide.position.copy(nl.blue),bd(_d(nl.amberFlow,r),rl.amber,rl.hold,r),yd($.blueGuide,rl.blueOrb,rl.hold,r,.8),$.bluePossibilityGuides.forEach((e,t)=>{let n=e.userData.direction||1,i=((nl.blueFlow*n+e.userData.flowOffset+Math.sin(r*.05+t)*.012)%1+1)%1;e.position.copy(vd(i,r,e.userData.ribAngle)),yd(e,rl.blueOrb*.58,rl.hold*.72,r,t*1.37)})}function gd(e){if(Y.mode===`landing`||Y.mode===`setup`||Y.mode===`closing`)return{amber:.34,blue:.34};if(!Y.running)return{amber:.02,blue:.02};if(Y.practiceMode===`breath`){if(e===`inhale`)return{amber:.025,blue:1};if(e===`pause`)return{amber:.015,blue:.015};if(e===`exhale`)return{amber:1,blue:.025};if(e===`rest`)return{amber:.08,blue:.08}}if(Y.practiceMode===`natural`){if(e===`present`)return{amber:.92,blue:.02};if(e===`opposite`)return{amber:.82,blue:.18};if(e===`include`)return{amber:.72,blue:.52};if(e===`hold`)return{amber:.018,blue:.018}}return e===`hold`?{amber:.72,blue:.72}:{amber:.5,blue:.5}}function _d(e,t){return e*Math.PI*2+Math.sin(t*.12)*.015}function vd(e,t=0,n=.42){let r=Math.sin(e*Math.PI*2+Math.PI*.28)*($c.height*.48),i=yl(r),a=n+Math.sin(t*.08+n)*.035;return new H(Math.sin(a)*i,r,Math.cos(a)*i*$c.depthScale)}function yd(e,t,n,r,i){let a=e.userData.core,o=e.userData.glow,s=e.userData.sparkles||[],c=Math.sin(r*3+i)*.5+.5,l=Math.max(0,Math.min(1,t)),u=e.userData.baseScale||1;e.scale.setScalar((.74+l*.28+n*.16+c*(.018+n*.035))*u),a.material.opacity=.2+l*.58+n*.1,o.material.opacity=.035+l*.11+n*(.09+c*.025);for(let e of s){let t=e.userData.seed,i=Math.max(0,Math.sin(r*4.1+t*3.3)),a=t*5.1+r*.7,o=.088+i*.045;e.position.set(Math.cos(a)*o,Math.sin(t*2.7+r*.82)*o*.72,Math.sin(a)*o*.5),e.scale.setScalar(.28+i*.92),e.material.opacity=n*i*.42}}function bd(e,t,n,r){if(!$.torusGuide)return;let i=$.torusGuide.userData.arc||Math.PI*.34,a=Math.sin(r*2.6)*.5+.5,o=Math.max(0,Math.min(1,t));$.torusGuide.rotation.y=-e-i*.5,$.torusGuide.scale.setScalar(1+o*.018+n*.045);let s=.16+o*.38+n*.16,c=.018+o*.085+n*(.12+a*.035);$.torusGuideCore.material.opacity=s,$.torusGuideGlow.material.opacity=c;for(let e of $.torusGuideCaps)e.material.opacity=s*.52;for(let e of $.torusGuideGlowCaps)e.material.opacity=c*.34}function xd(){nl.ready=!1,nl.lastTime=0,nl.amberSpeed=.7,nl.blueSpeed=.7}function Sd(e){return e<.5?2*e*e:1-(-2*e+2)**2/2}function Cd(e){let t=Math.max(0,Math.floor(e/1e3));return`${Math.floor(t/60)}:${String(t%60).padStart(2,`0`)}`}